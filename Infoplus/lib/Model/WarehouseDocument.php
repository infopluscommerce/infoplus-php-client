...
/**
 * WarehouseDocument Class Doc Comment
 *
 * @category Class
 * @package  Infoplus
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WarehouseDocument implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'warehouseDocument';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['printer_type'] = isset($data['printer_type']) ? $data['printer_type'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['printer_type'] === null) {
            $invalidProperties[] = "'printer_type' can't be null";
        }
     ...
     * Sets printer_type
     *
     * @param string $printer_type printer_type
     *
     * @return $this
     */
