...
/**
 * JobRecipeStep Class Doc Comment
 *
 * @category Class
 * @package  Infoplus
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JobRecipeStep implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'jobRecipeStep';
    ...
    {
        $this->container['sequence_no'] = isset($data['sequence_no']) ? $data['sequence_no'] : null;
     ...
     * Sets sequence_no
     *
     * @param int $sequence_no sequence_no
     *
     * @return $this
     */
