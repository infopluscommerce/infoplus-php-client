...
class InvoiceWorksheetLine implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['backup_file_url'] = isset($data['backup_file_url']) ? $data['backup_file_url'] : null;
    ...
    {
        return $this->container['backup_file_url'];
    }

    /**
     * Sets backup_file_url
     *
     * @param string $backup_file_url backup_file_url
     *
     * @return $this
     */
    public function setBackupFileUrl($backup_file_url)
    {
        $this->container['backup_file_url'] = $backup_file_url;
