...
class FulfillmentPlan implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['max_sk_us'] = isset($data['max_sk_us']) ? $data['max_sk_us'] : null;
    ...
    {
        return $this->container['max_sk_us'];
    }

    /**
     * Sets max_sk_us
     *
     * @param int $max_sk_us max_sk_us
     *
     * @return $this
     */
    public function setMaxSkUs($max_sk_us)
    {
        $this->container['max_sk_us'] = $max_sk_us;
