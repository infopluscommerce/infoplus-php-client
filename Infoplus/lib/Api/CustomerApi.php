...
class CustomerApi
{
    ...
    public function deleteCustomerWithHttpInfo($customer_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/customer/{customerId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getByCustomerNoWithHttpInfo($lob_id, $customer_no)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/customer/getByCustomerNo";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getCustomerByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/customer/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateCustomerByIdWithHttpInfo($customer_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/customer/duplicate/{customerId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->updateCustomerCustomFieldsWithHttpInfo ($body);
        return $response; 
    }


    /**
     * updateCustomerCustomFieldsWithHttpInfo
     *
     * Update a customer custom fields
     *
     * @param \Infoplus\Model\Customer $body Customer to be updated. (required)
    ...
    public function updateCustomerCustomFieldsWithHttpInfo($body)
    {
        ...
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling updateCustomerCustomFields');
        }
  
        // parse inputs
        $resourcePath = "/v2.0/customer/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
