...
class LineOfBusinessApi
{
    ...
    protected function addLineOfBusinessRequest($body)
    {
        ...
        $resourcePath = '/v3.0/lineOfBusiness';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLineOfBusinessAuditRequest($line_of_business_id, $line_of_business_audit)
    {
        ...
        $resourcePath = '/v3.0/lineOfBusiness/{lineOfBusinessId}/audit/{lineOfBusinessAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLineOfBusinessFileRequest($line_of_business_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/lineOfBusiness/{lineOfBusinessId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLineOfBusinessFileByURLRequest($body, $line_of_business_id)
    {
        ...
        $resourcePath = '/v3.0/lineOfBusiness/{lineOfBusinessId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLineOfBusinessTagRequest($line_of_business_id, $line_of_business_tag)
    {
        ...
        $resourcePath = '/v3.0/lineOfBusiness/{lineOfBusinessId}/tag/{lineOfBusinessTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteLineOfBusinessFileRequest($line_of_business_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/lineOfBusiness/{lineOfBusinessId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateLineOfBusinessByIdRequest($line_of_business_id)
    {
        ...
        $resourcePath = '/v3.0/lineOfBusiness/duplicate/{lineOfBusinessId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getLineOfBusinessByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/lineOfBusiness/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getLineOfBusinessByIdRequest($line_of_business_id)
    {
        ...
        $resourcePath = '/v3.0/lineOfBusiness/{lineOfBusinessId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getLineOfBusinessTagsRequest($line_of_business_id)
    {
        ...
        $resourcePath = '/v3.0/lineOfBusiness/{lineOfBusinessId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateLineOfBusinessCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/lineOfBusiness/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
