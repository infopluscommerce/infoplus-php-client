...
class FulfillmentPlanApi
{
    ...
    protected function addFulfillmentPlanRequest($body)
    {
        ...
        $resourcePath = '/v3.0/fulfillmentPlan';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addFulfillmentPlanAuditRequest($fulfillment_plan_id, $fulfillment_plan_audit)
    {
        ...
        $resourcePath = '/v3.0/fulfillmentPlan/{fulfillmentPlanId}/audit/{fulfillmentPlanAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addFulfillmentPlanFileRequest($fulfillment_plan_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/fulfillmentPlan/{fulfillmentPlanId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addFulfillmentPlanFileByURLRequest($body, $fulfillment_plan_id)
    {
        ...
        $resourcePath = '/v3.0/fulfillmentPlan/{fulfillmentPlanId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addFulfillmentPlanTagRequest($fulfillment_plan_id, $fulfillment_plan_tag)
    {
        ...
        $resourcePath = '/v3.0/fulfillmentPlan/{fulfillmentPlanId}/tag/{fulfillmentPlanTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteFulfillmentPlanRequest($fulfillment_plan_id)
    {
        ...
        $resourcePath = '/v3.0/fulfillmentPlan/{fulfillmentPlanId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteFulfillmentPlanFileRequest($fulfillment_plan_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/fulfillmentPlan/{fulfillmentPlanId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateFulfillmentPlanByIdRequest($fulfillment_plan_id)
    {
        ...
        $resourcePath = '/v3.0/fulfillmentPlan/duplicate/{fulfillmentPlanId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getFulfillmentPlanByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/fulfillmentPlan/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getFulfillmentPlanTagsRequest($fulfillment_plan_id)
    {
        ...
        $resourcePath = '/v3.0/fulfillmentPlan/{fulfillmentPlanId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateFulfillmentPlanCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/fulfillmentPlan/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
