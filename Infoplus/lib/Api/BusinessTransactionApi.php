...
class BusinessTransactionApi
{
    ...
    public function getBusinessTransactionByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/businessTransaction/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getBusinessTransactionByIdWithHttpInfo($business_transaction_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/businessTransaction/{businessTransactionId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateBusinessTransactionByIdWithHttpInfo($business_transaction_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/businessTransaction/duplicate/{businessTransactionId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateBusinessTransactionCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/businessTransaction/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
