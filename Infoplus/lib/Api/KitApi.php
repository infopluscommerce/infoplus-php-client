...
class KitApi
{
    ...
    protected function addKitAuditRequest($kit_id, $kit_audit)
    {
        ...
        $resourcePath = '/v3.0/kit/{kitId}/audit/{kitAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addKitFileRequest($kit_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/kit/{kitId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addKitFileByURLRequest($body, $kit_id)
    {
        ...
        $resourcePath = '/v3.0/kit/{kitId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addKitTagRequest($kit_id, $kit_tag)
    {
        ...
        $resourcePath = '/v3.0/kit/{kitId}/tag/{kitTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteKitFileRequest($kit_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/kit/{kitId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateKitByIdRequest($kit_id)
    {
        ...
        $resourcePath = '/v3.0/kit/duplicate/{kitId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getKitTagsRequest($kit_id)
    {
        ...
        $resourcePath = '/v3.0/kit/{kitId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateKitCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/kit/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
