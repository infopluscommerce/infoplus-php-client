...
class InvoiceWorksheetApi
{
    ...
    protected function addInvoiceWorksheetRequest($body)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheet';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInvoiceWorksheetAuditRequest($invoice_worksheet_id, $invoice_worksheet_audit)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheet/{invoiceWorksheetId}/audit/{invoiceWorksheetAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInvoiceWorksheetFileRequest($invoice_worksheet_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheet/{invoiceWorksheetId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInvoiceWorksheetFileByURLRequest($body, $invoice_worksheet_id)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheet/{invoiceWorksheetId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInvoiceWorksheetTagRequest($invoice_worksheet_id, $invoice_worksheet_tag)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheet/{invoiceWorksheetId}/tag/{invoiceWorksheetTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteInvoiceWorksheetRequest($invoice_worksheet_id)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheet/{invoiceWorksheetId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteInvoiceWorksheetFileRequest($invoice_worksheet_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheet/{invoiceWorksheetId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateInvoiceWorksheetByIdRequest($invoice_worksheet_id)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheet/duplicate/{invoiceWorksheetId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getInvoiceWorksheetByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheet/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getInvoiceWorksheetTagsRequest($invoice_worksheet_id)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheet/{invoiceWorksheetId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
