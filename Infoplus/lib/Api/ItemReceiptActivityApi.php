...
class ItemReceiptActivityApi
{
    ...
    protected function addItemReceiptActivityRequest($body)
    {
        ...
        $resourcePath = '/v3.0/itemReceiptActivity';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemReceiptActivityAuditRequest($item_receipt_activity_id, $item_receipt_activity_audit)
    {
        ...
        $resourcePath = '/v3.0/itemReceiptActivity/{itemReceiptActivityId}/audit/{itemReceiptActivityAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemReceiptActivityFileRequest($item_receipt_activity_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/itemReceiptActivity/{itemReceiptActivityId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemReceiptActivityFileByURLRequest($body, $item_receipt_activity_id)
    {
        ...
        $resourcePath = '/v3.0/itemReceiptActivity/{itemReceiptActivityId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemReceiptActivityTagRequest($item_receipt_activity_id, $item_receipt_activity_tag)
    {
        ...
        $resourcePath = '/v3.0/itemReceiptActivity/{itemReceiptActivityId}/tag/{itemReceiptActivityTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemReceiptActivityRequest($item_receipt_activity_id)
    {
        ...
        $resourcePath = '/v3.0/itemReceiptActivity/{itemReceiptActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemReceiptActivityFileRequest($item_receipt_activity_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/itemReceiptActivity/{itemReceiptActivityId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateItemReceiptActivityByIdRequest($item_receipt_activity_id)
    {
        ...
        $resourcePath = '/v3.0/itemReceiptActivity/duplicate/{itemReceiptActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemReceiptActivityByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/itemReceiptActivity/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemReceiptActivityTagsRequest($item_receipt_activity_id)
    {
        ...
        $resourcePath = '/v3.0/itemReceiptActivity/{itemReceiptActivityId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
