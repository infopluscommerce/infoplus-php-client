...
class OrderSourceReservationApi
{
    ...
    protected function addOrderSourceReservationRequest($body)
    {
        ...
        $resourcePath = '/v3.0/orderSourceReservation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderSourceReservationAuditRequest($order_source_reservation_id, $order_source_reservation_audit)
    {
        ...
        $resourcePath = '/v3.0/orderSourceReservation/{orderSourceReservationId}/audit/{orderSourceReservationAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderSourceReservationFileRequest($order_source_reservation_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/orderSourceReservation/{orderSourceReservationId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderSourceReservationFileByURLRequest($body, $order_source_reservation_id)
    {
        ...
        $resourcePath = '/v3.0/orderSourceReservation/{orderSourceReservationId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderSourceReservationTagRequest($order_source_reservation_id, $order_source_reservation_tag)
    {
        ...
        $resourcePath = '/v3.0/orderSourceReservation/{orderSourceReservationId}/tag/{orderSourceReservationTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteOrderSourceReservationRequest($order_source_reservation_id)
    {
        ...
        $resourcePath = '/v3.0/orderSourceReservation/{orderSourceReservationId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteOrderSourceReservationFileRequest($order_source_reservation_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/orderSourceReservation/{orderSourceReservationId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateOrderSourceReservationByIdRequest($order_source_reservation_id)
    {
        ...
        $resourcePath = '/v3.0/orderSourceReservation/duplicate/{orderSourceReservationId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getOrderSourceReservationByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/orderSourceReservation/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getOrderSourceReservationTagsRequest($order_source_reservation_id)
    {
        ...
        $resourcePath = '/v3.0/orderSourceReservation/{orderSourceReservationId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateOrderSourceReservationCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/orderSourceReservation/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
