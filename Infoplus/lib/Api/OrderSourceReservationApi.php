...
class OrderSourceReservationApi
{
    ...
    public function addOrderSourceReservationWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v1.0/orderSourceReservation";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function deleteOrderSourceReservationWithHttpInfo($order_source_reservation_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v1.0/orderSourceReservation/{orderSourceReservationId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getOrderSourceReservationByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v1.0/orderSourceReservation/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
