...
class ScheduledPlanLogApi
{
    ...
    public function getDuplicateScheduledPlanLogByIdWithHttpInfo($scheduled_plan_log_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/scheduledPlanLog/duplicate/{scheduledPlanLogId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getScheduledPlanLogByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/scheduledPlanLog/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getScheduledPlanLogByIdWithHttpInfo($scheduled_plan_log_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/scheduledPlanLog/{scheduledPlanLogId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
