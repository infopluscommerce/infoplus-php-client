...
class LocationFootprintApi
{
    ...
    protected function addLocationFootprintRequest($body)
    {
        ...
        $resourcePath = '/v3.0/locationFootprint';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLocationFootprintAuditRequest($location_footprint_id, $location_footprint_audit)
    {
        ...
        $resourcePath = '/v3.0/locationFootprint/{locationFootprintId}/audit/{locationFootprintAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLocationFootprintFileRequest($location_footprint_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/locationFootprint/{locationFootprintId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLocationFootprintFileByURLRequest($body, $location_footprint_id)
    {
        ...
        $resourcePath = '/v3.0/locationFootprint/{locationFootprintId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLocationFootprintTagRequest($location_footprint_id, $location_footprint_tag)
    {
        ...
        $resourcePath = '/v3.0/locationFootprint/{locationFootprintId}/tag/{locationFootprintTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteLocationFootprintRequest($location_footprint_id)
    {
        ...
        $resourcePath = '/v3.0/locationFootprint/{locationFootprintId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteLocationFootprintFileRequest($location_footprint_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/locationFootprint/{locationFootprintId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateLocationFootprintByIdRequest($location_footprint_id)
    {
        ...
        $resourcePath = '/v3.0/locationFootprint/duplicate/{locationFootprintId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getLocationFootprintByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/locationFootprint/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getLocationFootprintTagsRequest($location_footprint_id)
    {
        ...
        $resourcePath = '/v3.0/locationFootprint/{locationFootprintId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateLocationFootprintCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/locationFootprint/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
