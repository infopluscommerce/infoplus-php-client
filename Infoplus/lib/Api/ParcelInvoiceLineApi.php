...
class ParcelInvoiceLineApi
{
    ...
    protected function addParcelInvoiceLineAuditRequest($parcel_invoice_line_id, $parcel_invoice_line_audit)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoiceLine/{parcelInvoiceLineId}/audit/{parcelInvoiceLineAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addParcelInvoiceLineFileRequest($parcel_invoice_line_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoiceLine/{parcelInvoiceLineId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addParcelInvoiceLineFileByURLRequest($body, $parcel_invoice_line_id)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoiceLine/{parcelInvoiceLineId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addParcelInvoiceLineTagRequest($parcel_invoice_line_id, $parcel_invoice_line_tag)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoiceLine/{parcelInvoiceLineId}/tag/{parcelInvoiceLineTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteParcelInvoiceLineFileRequest($parcel_invoice_line_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoiceLine/{parcelInvoiceLineId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateParcelInvoiceLineByIdRequest($parcel_invoice_line_id)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoiceLine/duplicate/{parcelInvoiceLineId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getParcelInvoiceLineByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoiceLine/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getParcelInvoiceLineByIdRequest($parcel_invoice_line_id)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoiceLine/{parcelInvoiceLineId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getParcelInvoiceLineTagsRequest($parcel_invoice_line_id)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoiceLine/{parcelInvoiceLineId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateParcelInvoiceLineRequest($body)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoiceLine';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
