...
class CartLocationApi
{
    ...
    protected function addCartLocationAuditRequest($cart_location_id, $cart_location_audit)
    {
        ...
        $resourcePath = '/v3.0/cartLocation/{cartLocationId}/audit/{cartLocationAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartLocationFileRequest($cart_location_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/cartLocation/{cartLocationId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartLocationFileByURLRequest($body, $cart_location_id)
    {
        ...
        $resourcePath = '/v3.0/cartLocation/{cartLocationId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartLocationTagRequest($cart_location_id, $cart_location_tag)
    {
        ...
        $resourcePath = '/v3.0/cartLocation/{cartLocationId}/tag/{cartLocationTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteCartLocationFileRequest($cart_location_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/cartLocation/{cartLocationId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCartLocationByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/cartLocation/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCartLocationByIdRequest($cart_location_id)
    {
        ...
        $resourcePath = '/v3.0/cartLocation/{cartLocationId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCartLocationTagsRequest($cart_location_id)
    {
        ...
        $resourcePath = '/v3.0/cartLocation/{cartLocationId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateCartLocationByIdRequest($cart_location_id)
    {
        ...
        $resourcePath = '/v3.0/cartLocation/duplicate/{cartLocationId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
