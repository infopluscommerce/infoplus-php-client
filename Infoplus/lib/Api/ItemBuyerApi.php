...
class ItemBuyerApi
{
    ...
    protected function addItemBuyerAuditRequest($item_buyer_id, $item_buyer_audit)
    {
        ...
        $resourcePath = '/v3.0/itemBuyer/{itemBuyerId}/audit/{itemBuyerAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemBuyerFileRequest($item_buyer_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/itemBuyer/{itemBuyerId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemBuyerFileByURLRequest($body, $item_buyer_id)
    {
        ...
        $resourcePath = '/v3.0/itemBuyer/{itemBuyerId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemBuyerTagRequest($item_buyer_id, $item_buyer_tag)
    {
        ...
        $resourcePath = '/v3.0/itemBuyer/{itemBuyerId}/tag/{itemBuyerTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemBuyerRequest($item_buyer_id)
    {
        ...
        $resourcePath = '/v3.0/itemBuyer/{itemBuyerId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemBuyerFileRequest($item_buyer_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/itemBuyer/{itemBuyerId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateItemBuyerByIdRequest($item_buyer_id)
    {
        ...
        $resourcePath = '/v3.0/itemBuyer/duplicate/{itemBuyerId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemBuyerByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/itemBuyer/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemBuyerTagsRequest($item_buyer_id)
    {
        ...
        $resourcePath = '/v3.0/itemBuyer/{itemBuyerId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
