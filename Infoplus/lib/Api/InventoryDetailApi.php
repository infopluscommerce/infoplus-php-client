...
class InventoryDetailApi
{
    ...
    public function getDuplicateInventoryDetailByIdWithHttpInfo($inventory_detail_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/inventoryDetail/duplicate/{inventoryDetailId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getInventoryDetailByFilterWithHttpInfo ($filter, $page, $limit, $sort);
        return $response; 
    }


    /**
     * getInventoryDetailByFilterWithHttpInfo
     *
     * Search inventoryDetails by filter
     *
     * @param string $filter Query string, used to filter results. (optional)
    ...
    public function getInventoryDetailByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/inventoryDetail/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getInventoryDetailByIdWithHttpInfo ($inventory_detail_id);
        return $response; 
    }


    /**
     * getInventoryDetailByIdWithHttpInfo
     *
     * Get an inventoryDetail by id
     *
     * @param int $inventory_detail_id Id of the inventoryDetail to be returned. (required)
    ...
    public function getInventoryDetailByIdWithHttpInfo($inventory_detail_id)
    {
        ...
        // verify the required parameter 'inventory_detail_id' is set
        if ($inventory_detail_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $inventory_detail_id when calling getInventoryDetailById');
        }
  
        // parse inputs
        $resourcePath = "/v2.0/inventoryDetail/{inventoryDetailId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     *
     * @param \Infoplus\Model\InventoryDetail $body InventoryDetail to be updated. (required)
     * @return void
     * @throws \Infoplus\ApiException on non-2xx response
     */
    public function updateInventoryDetailCustomFields($body)
    {
        list($response, $statusCode, $httpHeader) = $this->updateInventoryDetailCustomFieldsWithHttpInfo ($body);
        return $response; 
    }


    /**
     * updateInventoryDetailCustomFieldsWithHttpInfo
     *
     * Update an inventoryDetail custom fields
     *
     * @param \Infoplus\Model\InventoryDetail $body InventoryDetail to be updated. (required)
    ...
    public function updateInventoryDetailCustomFieldsWithHttpInfo($body)
    {
        ...
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling updateInventoryDetailCustomFields');
        }
  
        // parse inputs
        $resourcePath = "/v2.0/inventoryDetail/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
