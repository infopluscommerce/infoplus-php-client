...
class BillingCodeApi
{
    ...
    protected function addBillingCodeAuditRequest($billing_code_id, $billing_code_audit)
    {
        ...
        $resourcePath = '/v3.0/billingCode/{billingCodeId}/audit/{billingCodeAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBillingCodeFileRequest($billing_code_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/billingCode/{billingCodeId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBillingCodeFileByURLRequest($body, $billing_code_id)
    {
        ...
        $resourcePath = '/v3.0/billingCode/{billingCodeId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBillingCodeTagRequest($billing_code_id, $billing_code_tag)
    {
        ...
        $resourcePath = '/v3.0/billingCode/{billingCodeId}/tag/{billingCodeTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteBillingCodeRequest($billing_code_id)
    {
        ...
        $resourcePath = '/v3.0/billingCode/{billingCodeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteBillingCodeFileRequest($billing_code_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/billingCode/{billingCodeId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getBillingCodeByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/billingCode/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getBillingCodeTagsRequest($billing_code_id)
    {
        ...
        $resourcePath = '/v3.0/billingCode/{billingCodeId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateBillingCodeByIdRequest($billing_code_id)
    {
        ...
        $resourcePath = '/v3.0/billingCode/duplicate/{billingCodeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateBillingCodeCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/billingCode/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
