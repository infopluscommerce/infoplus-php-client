...
class ReceivingProcessApi
{
    ...
    /**
     * Operation deleteReceivingProcess
     *
    ...
    {
        $this->deleteReceivingProcessWithHttpInfo($receiving_process_id);
    }

    /**
     * Operation deleteReceivingProcessWithHttpInfo
     *
     * Delete a receivingProcess
     *
     * @param  int $receiving_process_id Id of the receivingProcess to be deleted. (required)
    ...
    {
        $returnType = '';
        $request = $this->deleteReceivingProcessRequest($receiving_process_id);
    ...
    /**
     * Operation deleteReceivingProcessAsync
     *
     * Delete a receivingProcess
     *
     * @param  int $receiving_process_id Id of the receivingProcess to be deleted. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteReceivingProcessAsync($receiving_process_id)
    {
        return $this->deleteReceivingProcessAsyncWithHttpInfo($receiving_process_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteReceivingProcessAsyncWithHttpInfo
     *
     * Delete a receivingProcess
     *
     * @param  int $receiving_process_id Id of the receivingProcess to be deleted. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteReceivingProcessAsyncWithHttpInfo($receiving_process_id)
    {
        $returnType = '';
        $request = $this->deleteReceivingProcessRequest($receiving_process_id);
    ...
    /**
     * Create request for operation 'deleteReceivingProcess'
     *
     * @param  int $receiving_process_id Id of the receivingProcess to be deleted. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteReceivingProcessRequest($receiving_process_id)
    {
        // verify the required parameter 'receiving_process_id' is set
        if ($receiving_process_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $receiving_process_id when calling deleteReceivingProcess'
            );
        }
