...
class ReceivingProcessApi
{
    ...
    protected function addReceivingProcessAuditRequest($receiving_process_id, $receiving_process_audit)
    {
        ...
        $resourcePath = '/v3.0/receivingProcess/{receivingProcessId}/audit/{receivingProcessAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReceivingProcessFileRequest($receiving_process_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/receivingProcess/{receivingProcessId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReceivingProcessFileByURLRequest($body, $receiving_process_id)
    {
        ...
        $resourcePath = '/v3.0/receivingProcess/{receivingProcessId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReceivingProcessTagRequest($receiving_process_id, $receiving_process_tag)
    {
        ...
        $resourcePath = '/v3.0/receivingProcess/{receivingProcessId}/tag/{receivingProcessTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteReceivingProcessFileRequest($receiving_process_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/receivingProcess/{receivingProcessId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateReceivingProcessByIdRequest($receiving_process_id)
    {
        ...
        $resourcePath = '/v3.0/receivingProcess/duplicate/{receivingProcessId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getReceivingProcessByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/receivingProcess/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getReceivingProcessByIdRequest($receiving_process_id)
    {
        ...
        $resourcePath = '/v3.0/receivingProcess/{receivingProcessId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getReceivingProcessTagsRequest($receiving_process_id)
    {
        ...
        $resourcePath = '/v3.0/receivingProcess/{receivingProcessId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateReceivingProcessCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/receivingProcess/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
