...
class OrderSourceApi
{
    ...
    protected function addOrderSourceAuditRequest($order_source_id, $order_source_audit)
    {
        ...
        $resourcePath = '/v3.0/orderSource/{orderSourceId}/audit/{orderSourceAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderSourceFileRequest($order_source_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/orderSource/{orderSourceId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderSourceFileByURLRequest($body, $order_source_id)
    {
        ...
        $resourcePath = '/v3.0/orderSource/{orderSourceId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderSourceTagRequest($order_source_id, $order_source_tag)
    {
        ...
        $resourcePath = '/v3.0/orderSource/{orderSourceId}/tag/{orderSourceTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteOrderSourceRequest($order_source_id)
    {
        ...
        $resourcePath = '/v3.0/orderSource/{orderSourceId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteOrderSourceFileRequest($order_source_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/orderSource/{orderSourceId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateOrderSourceByIdRequest($order_source_id)
    {
        ...
        $resourcePath = '/v3.0/orderSource/duplicate/{orderSourceId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getOrderSourceByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/orderSource/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getOrderSourceTagsRequest($order_source_id)
    {
        ...
        $resourcePath = '/v3.0/orderSource/{orderSourceId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateOrderSourceCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/orderSource/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
