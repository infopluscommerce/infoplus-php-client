...
class BillOfLadingApi
{
    ...
    public function addBillOfLadingWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/billOfLading";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function deleteBillOfLadingWithHttpInfo($bill_of_lading_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/billOfLading/{billOfLadingId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getBillOfLadingByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/billOfLading/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateBillOfLadingByIdWithHttpInfo($bill_of_lading_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/billOfLading/duplicate/{billOfLadingId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->updateBillOfLadingCustomFieldsWithHttpInfo ($body);
        return $response; 
    }


    /**
     * updateBillOfLadingCustomFieldsWithHttpInfo
     *
     * Update a billOfLading custom fields
     *
     * @param \Infoplus\Model\BillOfLading $body BillOfLading to be updated. (required)
    ...
    public function updateBillOfLadingCustomFieldsWithHttpInfo($body)
    {
        ...
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling updateBillOfLadingCustomFields');
        }
  
        // parse inputs
        $resourcePath = "/v2.0/billOfLading/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
