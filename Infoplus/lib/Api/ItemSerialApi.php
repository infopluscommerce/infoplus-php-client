...
class ItemSerialApi
{
    ...
    protected function addItemSerialAuditRequest($item_serial_id, $item_serial_audit)
    {
        ...
        $resourcePath = '/v3.0/itemSerial/{itemSerialId}/audit/{itemSerialAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSerialFileRequest($item_serial_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/itemSerial/{itemSerialId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSerialFileByURLRequest($body, $item_serial_id)
    {
        ...
        $resourcePath = '/v3.0/itemSerial/{itemSerialId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSerialTagRequest($item_serial_id, $item_serial_tag)
    {
        ...
        $resourcePath = '/v3.0/itemSerial/{itemSerialId}/tag/{itemSerialTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemSerialRequest($item_serial_id)
    {
        ...
        $resourcePath = '/v3.0/itemSerial/{itemSerialId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemSerialFileRequest($item_serial_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/itemSerial/{itemSerialId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateItemSerialByIdRequest($item_serial_id)
    {
        ...
        $resourcePath = '/v3.0/itemSerial/duplicate/{itemSerialId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemSerialByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/itemSerial/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemSerialTagsRequest($item_serial_id)
    {
        ...
        $resourcePath = '/v3.0/itemSerial/{itemSerialId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
