...
class WarehouseDocumentApi
{
    ...
    protected function addWarehouseDocumentAuditRequest($warehouse_document_id, $warehouse_document_audit)
    {
        ...
        $resourcePath = '/v3.0/warehouseDocument/{warehouseDocumentId}/audit/{warehouseDocumentAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addWarehouseDocumentFileRequest($warehouse_document_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/warehouseDocument/{warehouseDocumentId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addWarehouseDocumentFileByURLRequest($body, $warehouse_document_id)
    {
        ...
        $resourcePath = '/v3.0/warehouseDocument/{warehouseDocumentId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addWarehouseDocumentTagRequest($warehouse_document_id, $warehouse_document_tag)
    {
        ...
        $resourcePath = '/v3.0/warehouseDocument/{warehouseDocumentId}/tag/{warehouseDocumentTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteWarehouseDocumentFileRequest($warehouse_document_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/warehouseDocument/{warehouseDocumentId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateWarehouseDocumentByIdRequest($warehouse_document_id)
    {
        ...
        $resourcePath = '/v3.0/warehouseDocument/duplicate/{warehouseDocumentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getWarehouseDocumentByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/warehouseDocument/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getWarehouseDocumentByIdRequest($warehouse_document_id)
    {
        ...
        $resourcePath = '/v3.0/warehouseDocument/{warehouseDocumentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getWarehouseDocumentTagsRequest($warehouse_document_id)
    {
        ...
        $resourcePath = '/v3.0/warehouseDocument/{warehouseDocumentId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateWarehouseDocumentCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/warehouseDocument/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
