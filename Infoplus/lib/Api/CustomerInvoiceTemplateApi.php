...
class CustomerInvoiceTemplateApi
{
    ...
    protected function addCustomerInvoiceTemplateRequest($body)
    {
        ...
        $resourcePath = '/v3.0/customerInvoiceTemplate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCustomerInvoiceTemplateAuditRequest($customer_invoice_template_id, $customer_invoice_template_audit)
    {
        ...
        $resourcePath = '/v3.0/customerInvoiceTemplate/{customerInvoiceTemplateId}/audit/{customerInvoiceTemplateAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCustomerInvoiceTemplateFileRequest($customer_invoice_template_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/customerInvoiceTemplate/{customerInvoiceTemplateId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCustomerInvoiceTemplateFileByURLRequest($body, $customer_invoice_template_id)
    {
        ...
        $resourcePath = '/v3.0/customerInvoiceTemplate/{customerInvoiceTemplateId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCustomerInvoiceTemplateTagRequest($customer_invoice_template_id, $customer_invoice_template_tag)
    {
        ...
        $resourcePath = '/v3.0/customerInvoiceTemplate/{customerInvoiceTemplateId}/tag/{customerInvoiceTemplateTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteCustomerInvoiceTemplateRequest($customer_invoice_template_id)
    {
        ...
        $resourcePath = '/v3.0/customerInvoiceTemplate/{customerInvoiceTemplateId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteCustomerInvoiceTemplateFileRequest($customer_invoice_template_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/customerInvoiceTemplate/{customerInvoiceTemplateId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCustomerInvoiceTemplateByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/customerInvoiceTemplate/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCustomerInvoiceTemplateTagsRequest($customer_invoice_template_id)
    {
        ...
        $resourcePath = '/v3.0/customerInvoiceTemplate/{customerInvoiceTemplateId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateCustomerInvoiceTemplateByIdRequest($customer_invoice_template_id)
    {
        ...
        $resourcePath = '/v3.0/customerInvoiceTemplate/duplicate/{customerInvoiceTemplateId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
