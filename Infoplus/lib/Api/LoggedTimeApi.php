...
class LoggedTimeApi
{
    ...
    protected function addLoggedTimeAuditRequest($logged_time_id, $logged_time_audit)
    {
        ...
        $resourcePath = '/v3.0/loggedTime/{loggedTimeId}/audit/{loggedTimeAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLoggedTimeFileRequest($logged_time_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/loggedTime/{loggedTimeId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLoggedTimeFileByURLRequest($body, $logged_time_id)
    {
        ...
        $resourcePath = '/v3.0/loggedTime/{loggedTimeId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLoggedTimeTagRequest($logged_time_id, $logged_time_tag)
    {
        ...
        $resourcePath = '/v3.0/loggedTime/{loggedTimeId}/tag/{loggedTimeTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteLoggedTimeFileRequest($logged_time_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/loggedTime/{loggedTimeId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateLoggedTimeByIdRequest($logged_time_id)
    {
        ...
        $resourcePath = '/v3.0/loggedTime/duplicate/{loggedTimeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getLoggedTimeByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/loggedTime/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getLoggedTimeByIdRequest($logged_time_id)
    {
        ...
        $resourcePath = '/v3.0/loggedTime/{loggedTimeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getLoggedTimeTagsRequest($logged_time_id)
    {
        ...
        $resourcePath = '/v3.0/loggedTime/{loggedTimeId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateLoggedTimeCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/loggedTime/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
