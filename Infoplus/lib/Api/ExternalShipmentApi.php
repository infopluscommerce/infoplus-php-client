...
class ExternalShipmentApi
{
    ...
    /**
     * Operation executeExternalShipment
     *
     * Run the ExecuteExternalShipment process.
     *
     * @param  \Infoplus\Infoplus\Model\ExecuteExternalShipmentInputAPIModel $body Input data for ExecuteExternalShipment process. (required)
     *
     * @throws \Infoplus\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Infoplus\Infoplus\Model\ProcessOutputAPIModel[]
     */
    public function executeExternalShipment($body)
    {
        list($response) = $this->executeExternalShipmentWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation executeExternalShipmentWithHttpInfo
     *
     * Run the ExecuteExternalShipment process.
     *
     * @param  \Infoplus\Infoplus\Model\ExecuteExternalShipmentInputAPIModel $body Input data for ExecuteExternalShipment process. (required)
     ...
     */
    public function executeExternalShipmentWithHttpInfo($body)
    {
        $returnType = '\Infoplus\Infoplus\Model\ProcessOutputAPIModel[]';
        $request = $this->executeExternalShipmentRequest($body);
    ...
    /**
     * Operation executeExternalShipmentAsync
     *
     * Run the ExecuteExternalShipment process.
     *
     * @param  \Infoplus\Infoplus\Model\ExecuteExternalShipmentInputAPIModel $body Input data for ExecuteExternalShipment process. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function executeExternalShipmentAsync($body)
    {
        return $this->executeExternalShipmentAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation executeExternalShipmentAsyncWithHttpInfo
     *
     * Run the ExecuteExternalShipment process.
     *
     * @param  \Infoplus\Infoplus\Model\ExecuteExternalShipmentInputAPIModel $body Input data for ExecuteExternalShipment process. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function executeExternalShipmentAsyncWithHttpInfo($body)
    {
        $returnType = '\Infoplus\Infoplus\Model\ProcessOutputAPIModel[]';
        $request = $this->executeExternalShipmentRequest($body);
    ...
    /**
     * Create request for operation 'executeExternalShipment'
     *
     * @param  \Infoplus\Infoplus\Model\ExecuteExternalShipmentInputAPIModel $body Input data for ExecuteExternalShipment process. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function executeExternalShipmentRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling executeExternalShipment'
            );
        }

        $resourcePath = '/beta/externalShipment/executeExternalShipment';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
