...
class ExternalShipmentApi
{
    ...
    protected function addExternalShipmentRequest($body)
    {
        ...
        $resourcePath = '/v3.0/externalShipment';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addExternalShipmentAuditRequest($external_shipment_id, $external_shipment_audit)
    {
        ...
        $resourcePath = '/v3.0/externalShipment/{externalShipmentId}/audit/{externalShipmentAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addExternalShipmentFileRequest($external_shipment_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/externalShipment/{externalShipmentId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addExternalShipmentFileByURLRequest($body, $external_shipment_id)
    {
        ...
        $resourcePath = '/v3.0/externalShipment/{externalShipmentId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addExternalShipmentTagRequest($external_shipment_id, $external_shipment_tag)
    {
        ...
        $resourcePath = '/v3.0/externalShipment/{externalShipmentId}/tag/{externalShipmentTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteExternalShipmentRequest($external_shipment_id)
    {
        ...
        $resourcePath = '/v3.0/externalShipment/{externalShipmentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteExternalShipmentFileRequest($external_shipment_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/externalShipment/{externalShipmentId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateExternalShipmentByIdRequest($external_shipment_id)
    {
        ...
        $resourcePath = '/v3.0/externalShipment/duplicate/{externalShipmentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getExternalShipmentByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/externalShipment/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getExternalShipmentTagsRequest($external_shipment_id)
    {
        ...
        $resourcePath = '/v3.0/externalShipment/{externalShipmentId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateExternalShipmentCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/externalShipment/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
