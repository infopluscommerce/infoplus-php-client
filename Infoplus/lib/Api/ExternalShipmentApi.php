...
class ExternalShipmentApi
{
    ...
    public function addExternalShipmentWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/externalShipment";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function deleteExternalShipmentWithHttpInfo($external_shipment_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/externalShipment/{externalShipmentId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateExternalShipmentByIdWithHttpInfo($external_shipment_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/externalShipment/duplicate/{externalShipmentId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getExternalShipmentByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/externalShipment/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateExternalShipmentCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/externalShipment/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
