...
class OrderLineApi
{
    ...
    public function getDuplicateOrderLineByIdWithHttpInfo($order_line_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/orderLine/duplicate/{orderLineId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getOrderLineByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/orderLine/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getOrderLineByIdWithHttpInfo($order_line_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/orderLine/{orderLineId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateOrderLineCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/orderLine/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
