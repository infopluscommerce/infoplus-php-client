...
class PickFaceAssignmentApi
{
    ...
    protected function addPickFaceAssignmentRequest($body)
    {
        ...
        $resourcePath = '/v3.0/pickFaceAssignment';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addPickFaceAssignmentAuditRequest($pick_face_assignment_id, $pick_face_assignment_audit)
    {
        ...
        $resourcePath = '/v3.0/pickFaceAssignment/{pickFaceAssignmentId}/audit/{pickFaceAssignmentAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addPickFaceAssignmentFileRequest($pick_face_assignment_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/pickFaceAssignment/{pickFaceAssignmentId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addPickFaceAssignmentFileByURLRequest($body, $pick_face_assignment_id)
    {
        ...
        $resourcePath = '/v3.0/pickFaceAssignment/{pickFaceAssignmentId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addPickFaceAssignmentTagRequest($pick_face_assignment_id, $pick_face_assignment_tag)
    {
        ...
        $resourcePath = '/v3.0/pickFaceAssignment/{pickFaceAssignmentId}/tag/{pickFaceAssignmentTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deletePickFaceAssignmentRequest($pick_face_assignment_id)
    {
        ...
        $resourcePath = '/v3.0/pickFaceAssignment/{pickFaceAssignmentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deletePickFaceAssignmentFileRequest($pick_face_assignment_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/pickFaceAssignment/{pickFaceAssignmentId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicatePickFaceAssignmentByIdRequest($pick_face_assignment_id)
    {
        ...
        $resourcePath = '/v3.0/pickFaceAssignment/duplicate/{pickFaceAssignmentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getPickFaceAssignmentByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/pickFaceAssignment/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getPickFaceAssignmentTagsRequest($pick_face_assignment_id)
    {
        ...
        $resourcePath = '/v3.0/pickFaceAssignment/{pickFaceAssignmentId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updatePickFaceAssignmentCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/pickFaceAssignment/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
