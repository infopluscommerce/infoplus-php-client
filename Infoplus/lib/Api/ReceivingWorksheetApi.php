...
class ReceivingWorksheetApi
{
    ...
    protected function addReceivingWorksheetRequest($body)
    {
        ...
        $resourcePath = '/v3.0/receivingWorksheet';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReceivingWorksheetAuditRequest($receiving_worksheet_id, $receiving_worksheet_audit)
    {
        ...
        $resourcePath = '/v3.0/receivingWorksheet/{receivingWorksheetId}/audit/{receivingWorksheetAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReceivingWorksheetFileRequest($receiving_worksheet_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/receivingWorksheet/{receivingWorksheetId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReceivingWorksheetFileByURLRequest($body, $receiving_worksheet_id)
    {
        ...
        $resourcePath = '/v3.0/receivingWorksheet/{receivingWorksheetId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReceivingWorksheetTagRequest($receiving_worksheet_id, $receiving_worksheet_tag)
    {
        ...
        $resourcePath = '/v3.0/receivingWorksheet/{receivingWorksheetId}/tag/{receivingWorksheetTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteReceivingWorksheetRequest($receiving_worksheet_id)
    {
        ...
        $resourcePath = '/v3.0/receivingWorksheet/{receivingWorksheetId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteReceivingWorksheetFileRequest($receiving_worksheet_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/receivingWorksheet/{receivingWorksheetId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateReceivingWorksheetByIdRequest($receiving_worksheet_id)
    {
        ...
        $resourcePath = '/v3.0/receivingWorksheet/duplicate/{receivingWorksheetId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getReceivingWorksheetByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/receivingWorksheet/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getReceivingWorksheetTagsRequest($receiving_worksheet_id)
    {
        ...
        $resourcePath = '/v3.0/receivingWorksheet/{receivingWorksheetId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateReceivingWorksheetCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/receivingWorksheet/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
