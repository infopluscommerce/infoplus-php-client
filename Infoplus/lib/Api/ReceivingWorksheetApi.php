...
class ReceivingWorksheetApi
{
     ...
     *
     * @param \Infoplus\Model\ReceivingWorksheet $body ReceivingWorksheet to be inserted. (required)
     * @return \Infoplus\Model\ReceivingWorksheet
     * @throws \Infoplus\ApiException on non-2xx response
     */
    public function addReceivingWorksheet($body)
    {
        list($response, $statusCode, $httpHeader) = $this->addReceivingWorksheetWithHttpInfo ($body);
        return $response; 
    }


    /**
     * addReceivingWorksheetWithHttpInfo
     *
     * Create a receivingWorksheet
     *
     * @param \Infoplus\Model\ReceivingWorksheet $body ReceivingWorksheet to be inserted. (required)
     * @return Array of \Infoplus\Model\ReceivingWorksheet, HTTP status code, HTTP response headers (array of strings)
     * @throws \Infoplus\ApiException on non-2xx response
     */
    public function addReceivingWorksheetWithHttpInfo($body)
    {
        ...
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling addReceivingWorksheet');
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\Infoplus\Model\ReceivingWorksheet'
            );
            ...
            return array(\Infoplus\ObjectSerializer::deserialize($response, '\Infoplus\Model\ReceivingWorksheet', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \Infoplus\ObjectSerializer::deserialize($e->getResponseBody(), '\Infoplus\Model\ReceivingWorksheet', $e->getResponseHeaders());
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->deleteReceivingWorksheetWithHttpInfo ($receiving_worksheet_id);
        return $response; 
    }


    /**
     * deleteReceivingWorksheetWithHttpInfo
     *
     * Delete a receivingWorksheet
     *
     * @param int $receiving_worksheet_id Id of the receivingWorksheet to be deleted. (required)
    ...
    public function deleteReceivingWorksheetWithHttpInfo($receiving_worksheet_id)
    {
        ...
        if ($receiving_worksheet_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $receiving_worksheet_id when calling deleteReceivingWorksheet');
        }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getDuplicateReceivingWorksheetByIdWithHttpInfo ($receiving_worksheet_id);
        return $response; 
    }


    /**
     * getDuplicateReceivingWorksheetByIdWithHttpInfo
     *
     * Get a duplicated a receivingWorksheet by id
     *
     * @param int $receiving_worksheet_id Id of the receivingWorksheet to be duplicated. (required)
    ...
    public function getDuplicateReceivingWorksheetByIdWithHttpInfo($receiving_worksheet_id)
    {
        ...
        // verify the required parameter 'receiving_worksheet_id' is set
        if ($receiving_worksheet_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $receiving_worksheet_id when calling getDuplicateReceivingWorksheetById');
        }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getReceivingWorksheetByFilterWithHttpInfo ($filter, $page, $limit, $sort);
        return $response; 
    }


    /**
     * getReceivingWorksheetByFilterWithHttpInfo
     *
     * Search receivingWorksheets by filter
     *
     * @param string $filter Query string, used to filter results. (optional)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getReceivingWorksheetByIdWithHttpInfo ($receiving_worksheet_id);
        return $response; 
    }


    /**
     * getReceivingWorksheetByIdWithHttpInfo
     *
     * Get a receivingWorksheet by id
     *
     * @param int $receiving_worksheet_id Id of the receivingWorksheet to be returned. (required)
    ...
    public function getReceivingWorksheetByIdWithHttpInfo($receiving_worksheet_id)
    {
        ...
        // verify the required parameter 'receiving_worksheet_id' is set
        if ($receiving_worksheet_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $receiving_worksheet_id when calling getReceivingWorksheetById');
        }
     ...
     *
     * @param \Infoplus\Model\ReceivingWorksheet $body ReceivingWorksheet to be updated. (required)
     * @return void
     * @throws \Infoplus\ApiException on non-2xx response
     */
    public function updateReceivingWorksheet($body)
    {
        list($response, $statusCode, $httpHeader) = $this->updateReceivingWorksheetWithHttpInfo ($body);
        return $response; 
    }


    /**
     * updateReceivingWorksheetWithHttpInfo
     *
     * Update a receivingWorksheet
     *
     * @param \Infoplus\Model\ReceivingWorksheet $body ReceivingWorksheet to be updated. (required)
    ...
    public function updateReceivingWorksheetWithHttpInfo($body)
    {
        ...
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling updateReceivingWorksheet');
        }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->updateReceivingWorksheetCustomFieldsWithHttpInfo ($body);
        return $response; 
    }


    /**
     * updateReceivingWorksheetCustomFieldsWithHttpInfo
     *
     * Update a receivingWorksheet custom fields
     *
     * @param \Infoplus\Model\ReceivingWorksheet $body ReceivingWorksheet to be updated. (required)
    ...
    public function updateReceivingWorksheetCustomFieldsWithHttpInfo($body)
    {
        ...
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling updateReceivingWorksheetCustomFields');
        }
