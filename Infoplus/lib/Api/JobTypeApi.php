...
class JobTypeApi
{
    ...
    protected function addJobTypeAuditRequest($job_type_id, $job_type_audit)
    {
        ...
        $resourcePath = '/v3.0/jobType/{jobTypeId}/audit/{jobTypeAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addJobTypeFileRequest($job_type_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/jobType/{jobTypeId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addJobTypeFileByURLRequest($body, $job_type_id)
    {
        ...
        $resourcePath = '/v3.0/jobType/{jobTypeId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addJobTypeTagRequest($job_type_id, $job_type_tag)
    {
        ...
        $resourcePath = '/v3.0/jobType/{jobTypeId}/tag/{jobTypeTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteJobTypeRequest($job_type_id)
    {
        ...
        $resourcePath = '/v3.0/jobType/{jobTypeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteJobTypeFileRequest($job_type_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/jobType/{jobTypeId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateJobTypeByIdRequest($job_type_id)
    {
        ...
        $resourcePath = '/v3.0/jobType/duplicate/{jobTypeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getJobTypeByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/jobType/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getJobTypeTagsRequest($job_type_id)
    {
        ...
        $resourcePath = '/v3.0/jobType/{jobTypeId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateJobTypeCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/jobType/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
