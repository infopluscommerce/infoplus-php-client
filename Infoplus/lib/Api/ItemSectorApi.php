...
class ItemSectorApi
{
    ...
    protected function addItemSectorAuditRequest($item_sector_id, $item_sector_audit)
    {
        ...
        $resourcePath = '/v3.0/itemSector/{itemSectorId}/audit/{itemSectorAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSectorFileRequest($item_sector_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/itemSector/{itemSectorId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSectorFileByURLRequest($body, $item_sector_id)
    {
        ...
        $resourcePath = '/v3.0/itemSector/{itemSectorId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSectorTagRequest($item_sector_id, $item_sector_tag)
    {
        ...
        $resourcePath = '/v3.0/itemSector/{itemSectorId}/tag/{itemSectorTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemSectorRequest($item_sector_id)
    {
        ...
        $resourcePath = '/v3.0/itemSector/{itemSectorId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemSectorFileRequest($item_sector_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/itemSector/{itemSectorId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateItemSectorByIdRequest($item_sector_id)
    {
        ...
        $resourcePath = '/v3.0/itemSector/duplicate/{itemSectorId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemSectorByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/itemSector/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemSectorTagsRequest($item_sector_id)
    {
        ...
        $resourcePath = '/v3.0/itemSector/{itemSectorId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
