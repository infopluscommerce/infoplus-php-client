...
class CustomFieldApi
{
    ...
    protected function addCustomFieldAuditRequest($custom_field_id, $custom_field_audit)
    {
        ...
        $resourcePath = '/v3.0/customField/{customFieldId}/audit/{customFieldAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCustomFieldFileRequest($custom_field_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/customField/{customFieldId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCustomFieldFileByURLRequest($body, $custom_field_id)
    {
        ...
        $resourcePath = '/v3.0/customField/{customFieldId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCustomFieldTagRequest($custom_field_id, $custom_field_tag)
    {
        ...
        $resourcePath = '/v3.0/customField/{customFieldId}/tag/{customFieldTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteCustomFieldFileRequest($custom_field_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/customField/{customFieldId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCustomFieldByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/customField/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCustomFieldByIdRequest($custom_field_id)
    {
        ...
        $resourcePath = '/v3.0/customField/{customFieldId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCustomFieldTagsRequest($custom_field_id)
    {
        ...
        $resourcePath = '/v3.0/customField/{customFieldId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateCustomFieldByIdRequest($custom_field_id)
    {
        ...
        $resourcePath = '/v3.0/customField/duplicate/{customFieldId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
