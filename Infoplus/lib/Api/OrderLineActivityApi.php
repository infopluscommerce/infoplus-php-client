...
class OrderLineActivityApi
{
    ...
    protected function addOrderLineActivityRequest($body)
    {
        ...
        $resourcePath = '/v3.0/orderLineActivity';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderLineActivityAuditRequest($order_line_activity_id, $order_line_activity_audit)
    {
        ...
        $resourcePath = '/v3.0/orderLineActivity/{orderLineActivityId}/audit/{orderLineActivityAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderLineActivityFileRequest($order_line_activity_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/orderLineActivity/{orderLineActivityId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderLineActivityFileByURLRequest($body, $order_line_activity_id)
    {
        ...
        $resourcePath = '/v3.0/orderLineActivity/{orderLineActivityId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderLineActivityTagRequest($order_line_activity_id, $order_line_activity_tag)
    {
        ...
        $resourcePath = '/v3.0/orderLineActivity/{orderLineActivityId}/tag/{orderLineActivityTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteOrderLineActivityRequest($order_line_activity_id)
    {
        ...
        $resourcePath = '/v3.0/orderLineActivity/{orderLineActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteOrderLineActivityFileRequest($order_line_activity_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/orderLineActivity/{orderLineActivityId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateOrderLineActivityByIdRequest($order_line_activity_id)
    {
        ...
        $resourcePath = '/v3.0/orderLineActivity/duplicate/{orderLineActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getOrderLineActivityByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/orderLineActivity/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getOrderLineActivityTagsRequest($order_line_activity_id)
    {
        ...
        $resourcePath = '/v3.0/orderLineActivity/{orderLineActivityId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
