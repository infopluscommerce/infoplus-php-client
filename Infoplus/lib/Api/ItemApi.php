...
class ItemApi
{
    ...
    public function getBySKUWithHttpInfo($lob_id, $sku)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/item/getBySKU";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateItemByIdWithHttpInfo($item_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/item/duplicate/{itemId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateItemCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/item/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
