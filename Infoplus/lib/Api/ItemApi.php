...
class ItemApi
{
    ...
    protected function addItemAuditRequest($item_id, $item_audit)
    {
        ...
        $resourcePath = '/v3.0/item/{itemId}/audit/{itemAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemFileRequest($item_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/item/{itemId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemFileByURLRequest($body, $item_id)
    {
        ...
        $resourcePath = '/v3.0/item/{itemId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemTagRequest($item_id, $item_tag)
    {
        ...
        $resourcePath = '/v3.0/item/{itemId}/tag/{itemTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemFileRequest($item_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/item/{itemId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getBySKURequest($lob_id, $sku)
    {
        ...
        $resourcePath = '/v3.0/item/getBySKU';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateItemByIdRequest($item_id)
    {
        ...
        $resourcePath = '/v3.0/item/duplicate/{itemId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemTagsRequest($item_id)
    {
        ...
        $resourcePath = '/v3.0/item/{itemId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateItemCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/item/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
