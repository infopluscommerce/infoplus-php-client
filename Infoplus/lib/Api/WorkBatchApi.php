...
class WorkBatchApi
{
    ...
    protected function addWorkBatchAuditRequest($work_batch_id, $work_batch_audit)
    {
        ...
        $resourcePath = '/v3.0/workBatch/{workBatchId}/audit/{workBatchAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addWorkBatchFileRequest($work_batch_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/workBatch/{workBatchId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addWorkBatchFileByURLRequest($body, $work_batch_id)
    {
        ...
        $resourcePath = '/v3.0/workBatch/{workBatchId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addWorkBatchTagRequest($work_batch_id, $work_batch_tag)
    {
        ...
        $resourcePath = '/v3.0/workBatch/{workBatchId}/tag/{workBatchTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteWorkBatchFileRequest($work_batch_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/workBatch/{workBatchId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateWorkBatchByIdRequest($work_batch_id)
    {
        ...
        $resourcePath = '/v3.0/workBatch/duplicate/{workBatchId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getWorkBatchByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/workBatch/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getWorkBatchByIdRequest($work_batch_id)
    {
        ...
        $resourcePath = '/v3.0/workBatch/{workBatchId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getWorkBatchTagsRequest($work_batch_id)
    {
        ...
        $resourcePath = '/v3.0/workBatch/{workBatchId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateWorkBatchCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/workBatch/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
