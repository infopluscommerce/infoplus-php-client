...
class WorkBatchApi
{
    ...
    public function getDuplicateWorkBatchByIdWithHttpInfo($work_batch_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/workBatch/duplicate/{workBatchId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getWorkBatchByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/workBatch/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getWorkBatchByIdWithHttpInfo($work_batch_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/workBatch/{workBatchId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateWorkBatchCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/workBatch/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
