...
class ItemLowstockCodeApi
{
    ...
    public function addItemLowstockCodeWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/itemLowstockCode";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function deleteItemLowstockCodeWithHttpInfo($item_lowstock_code_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/itemLowstockCode/{itemLowstockCodeId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateItemLowstockCodeByIdWithHttpInfo($item_lowstock_code_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/itemLowstockCode/duplicate/{itemLowstockCodeId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getItemLowstockCodeByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/itemLowstockCode/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
