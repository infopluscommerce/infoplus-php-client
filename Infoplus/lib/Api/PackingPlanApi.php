...
class PackingPlanApi
{
    ...
    protected function addPackingPlanAuditRequest($packing_plan_id, $packing_plan_audit)
    {
        ...
        $resourcePath = '/v3.0/packingPlan/{packingPlanId}/audit/{packingPlanAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addPackingPlanFileRequest($packing_plan_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/packingPlan/{packingPlanId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addPackingPlanFileByURLRequest($body, $packing_plan_id)
    {
        ...
        $resourcePath = '/v3.0/packingPlan/{packingPlanId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addPackingPlanTagRequest($packing_plan_id, $packing_plan_tag)
    {
        ...
        $resourcePath = '/v3.0/packingPlan/{packingPlanId}/tag/{packingPlanTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deletePackingPlanRequest($packing_plan_id)
    {
        ...
        $resourcePath = '/v3.0/packingPlan/{packingPlanId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deletePackingPlanFileRequest($packing_plan_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/packingPlan/{packingPlanId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicatePackingPlanByIdRequest($packing_plan_id)
    {
        ...
        $resourcePath = '/v3.0/packingPlan/duplicate/{packingPlanId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getPackingPlanByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/packingPlan/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getPackingPlanTagsRequest($packing_plan_id)
    {
        ...
        $resourcePath = '/v3.0/packingPlan/{packingPlanId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updatePackingPlanCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/packingPlan/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
