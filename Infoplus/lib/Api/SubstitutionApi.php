...
class SubstitutionApi
{
    ...
    protected function addSubstitutionRequest($body)
    {
        ...
        $resourcePath = '/v3.0/substitution';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addSubstitutionAuditRequest($substitution_id, $substitution_audit)
    {
        ...
        $resourcePath = '/v3.0/substitution/{substitutionId}/audit/{substitutionAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addSubstitutionFileRequest($substitution_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/substitution/{substitutionId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addSubstitutionFileByURLRequest($body, $substitution_id)
    {
        ...
        $resourcePath = '/v3.0/substitution/{substitutionId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addSubstitutionTagRequest($substitution_id, $substitution_tag)
    {
        ...
        $resourcePath = '/v3.0/substitution/{substitutionId}/tag/{substitutionTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteSubstitutionRequest($substitution_id)
    {
        ...
        $resourcePath = '/v3.0/substitution/{substitutionId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteSubstitutionFileRequest($substitution_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/substitution/{substitutionId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateSubstitutionByIdRequest($substitution_id)
    {
        ...
        $resourcePath = '/v3.0/substitution/duplicate/{substitutionId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getSubstitutionByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/substitution/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getSubstitutionTagsRequest($substitution_id)
    {
        ...
        $resourcePath = '/v3.0/substitution/{substitutionId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateSubstitutionCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/substitution/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
