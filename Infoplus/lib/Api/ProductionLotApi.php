...
class ProductionLotApi
{
    ...
    protected function addProductionLotRequest($body)
    {
        ...
        $resourcePath = '/v3.0/productionLot';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addProductionLotAuditRequest($production_lot_id, $production_lot_audit)
    {
        ...
        $resourcePath = '/v3.0/productionLot/{productionLotId}/audit/{productionLotAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addProductionLotFileRequest($production_lot_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/productionLot/{productionLotId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addProductionLotFileByURLRequest($body, $production_lot_id)
    {
        ...
        $resourcePath = '/v3.0/productionLot/{productionLotId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addProductionLotTagRequest($production_lot_id, $production_lot_tag)
    {
        ...
        $resourcePath = '/v3.0/productionLot/{productionLotId}/tag/{productionLotTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteProductionLotRequest($production_lot_id)
    {
        ...
        $resourcePath = '/v3.0/productionLot/{productionLotId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteProductionLotFileRequest($production_lot_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/productionLot/{productionLotId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateProductionLotByIdRequest($production_lot_id)
    {
        ...
        $resourcePath = '/v3.0/productionLot/duplicate/{productionLotId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getProductionLotByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/productionLot/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getProductionLotTagsRequest($production_lot_id)
    {
        ...
        $resourcePath = '/v3.0/productionLot/{productionLotId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateProductionLotCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/productionLot/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
