...
class JobTimeApi
{
    ...
    protected function addJobTimeAuditRequest($job_time_id, $job_time_audit)
    {
        ...
        $resourcePath = '/v3.0/jobTime/{jobTimeId}/audit/{jobTimeAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addJobTimeFileRequest($job_time_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/jobTime/{jobTimeId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addJobTimeFileByURLRequest($body, $job_time_id)
    {
        ...
        $resourcePath = '/v3.0/jobTime/{jobTimeId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addJobTimeTagRequest($job_time_id, $job_time_tag)
    {
        ...
        $resourcePath = '/v3.0/jobTime/{jobTimeId}/tag/{jobTimeTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteJobTimeRequest($job_time_id)
    {
        ...
        $resourcePath = '/v3.0/jobTime/{jobTimeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteJobTimeFileRequest($job_time_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/jobTime/{jobTimeId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateJobTimeByIdRequest($job_time_id)
    {
        ...
        $resourcePath = '/v3.0/jobTime/duplicate/{jobTimeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getJobTimeByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/jobTime/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getJobTimeTagsRequest($job_time_id)
    {
        ...
        $resourcePath = '/v3.0/jobTime/{jobTimeId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateJobTimeCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/jobTime/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
