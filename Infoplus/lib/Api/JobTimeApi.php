...
class JobTimeApi
{
    ...
    public function deleteJobTimeWithHttpInfo($job_time_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/jobTime/{jobTimeId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateJobTimeByIdWithHttpInfo($job_time_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/jobTime/duplicate/{jobTimeId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getJobTimeByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/jobTime/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateJobTimeCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/jobTime/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
