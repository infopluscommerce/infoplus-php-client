...
class JobRecipeApi
{
    ...
    protected function addJobRecipeAuditRequest($job_recipe_id, $job_recipe_audit)
    {
        ...
        $resourcePath = '/v3.0/jobRecipe/{jobRecipeId}/audit/{jobRecipeAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addJobRecipeFileRequest($job_recipe_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/jobRecipe/{jobRecipeId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addJobRecipeFileByURLRequest($body, $job_recipe_id)
    {
        ...
        $resourcePath = '/v3.0/jobRecipe/{jobRecipeId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addJobRecipeTagRequest($job_recipe_id, $job_recipe_tag)
    {
        ...
        $resourcePath = '/v3.0/jobRecipe/{jobRecipeId}/tag/{jobRecipeTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteJobRecipeRequest($job_recipe_id)
    {
        ...
        $resourcePath = '/v3.0/jobRecipe/{jobRecipeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteJobRecipeFileRequest($job_recipe_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/jobRecipe/{jobRecipeId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateJobRecipeByIdRequest($job_recipe_id)
    {
        ...
        $resourcePath = '/v3.0/jobRecipe/duplicate/{jobRecipeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getJobRecipeByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/jobRecipe/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getJobRecipeTagsRequest($job_recipe_id)
    {
        ...
        $resourcePath = '/v3.0/jobRecipe/{jobRecipeId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateJobRecipeCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/jobRecipe/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
