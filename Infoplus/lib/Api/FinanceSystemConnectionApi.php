...
class FinanceSystemConnectionApi
{
    ...
    protected function addFinanceSystemConnectionRequest($body)
    {
        ...
        $resourcePath = '/v3.0/financeSystemConnection';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addFinanceSystemConnectionAuditRequest($finance_system_connection_id, $finance_system_connection_audit)
    {
        ...
        $resourcePath = '/v3.0/financeSystemConnection/{financeSystemConnectionId}/audit/{financeSystemConnectionAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addFinanceSystemConnectionFileRequest($finance_system_connection_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/financeSystemConnection/{financeSystemConnectionId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addFinanceSystemConnectionFileByURLRequest($body, $finance_system_connection_id)
    {
        ...
        $resourcePath = '/v3.0/financeSystemConnection/{financeSystemConnectionId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addFinanceSystemConnectionTagRequest($finance_system_connection_id, $finance_system_connection_tag)
    {
        ...
        $resourcePath = '/v3.0/financeSystemConnection/{financeSystemConnectionId}/tag/{financeSystemConnectionTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteFinanceSystemConnectionRequest($finance_system_connection_id)
    {
        ...
        $resourcePath = '/v3.0/financeSystemConnection/{financeSystemConnectionId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteFinanceSystemConnectionFileRequest($finance_system_connection_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/financeSystemConnection/{financeSystemConnectionId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateFinanceSystemConnectionByIdRequest($finance_system_connection_id)
    {
        ...
        $resourcePath = '/v3.0/financeSystemConnection/duplicate/{financeSystemConnectionId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getFinanceSystemConnectionByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/financeSystemConnection/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getFinanceSystemConnectionTagsRequest($finance_system_connection_id)
    {
        ...
        $resourcePath = '/v3.0/financeSystemConnection/{financeSystemConnectionId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateFinanceSystemConnectionCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/financeSystemConnection/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
