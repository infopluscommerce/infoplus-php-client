...
class LocationBillingTypeApi
{
    ...
    public function addLocationBillingTypeWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/locationBillingType";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function deleteLocationBillingTypeWithHttpInfo($location_billing_type_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/locationBillingType/{locationBillingTypeId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateLocationBillingTypeByIdWithHttpInfo($location_billing_type_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/locationBillingType/duplicate/{locationBillingTypeId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getLocationBillingTypeByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/locationBillingType/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * updateLocationBillingTypeCustomFieldsWithHttpInfo
     *
     * Update a locationBillingType custom fields
     *
     * @param \Infoplus\Model\LocationBillingType $body LocationBillingType to be updated. (required)
    ...
    public function updateLocationBillingTypeCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/locationBillingType/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
