...
class PackingSlipTemplateLineItemDescriptionEnumApi
{
     ...
     * @return PackingSlipTemplateLineItemDescriptionEnumApi
     */
     ...
     * @return \Infoplus\Model\PackingSlipTemplateLineItemDescriptionEnum
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getPackingSlipTemplateLineItemDescriptionEnumByIdWithHttpInfo ($packing_slip_template_line_item_description_enum_id);
        return $response; 
    }


    /**
     * getPackingSlipTemplateLineItemDescriptionEnumByIdWithHttpInfo
     *
     * Get a packingSlipTemplateLineItemDescriptionEnum by id
     *
     * @param string $packing_slip_template_line_item_description_enum_id Id of packingSlipTemplateLineItemDescriptionEnum to be returned. (required)
     * @return Array of \Infoplus\Model\PackingSlipTemplateLineItemDescriptionEnum, HTTP status code, HTTP response headers (array of strings)
     * @throws \Infoplus\ApiException on non-2xx response
     */
    public function getPackingSlipTemplateLineItemDescriptionEnumByIdWithHttpInfo($packing_slip_template_line_item_description_enum_id)
    {
        ...
        if ($packing_slip_template_line_item_description_enum_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $packing_slip_template_line_item_description_enum_id when calling getPackingSlipTemplateLineItemDescriptionEnumById');
        }
        ...
        if ($packing_slip_template_line_item_description_enum_id !== null) {
            $resourcePath = str_replace(
                ...
                $this->apiClient->getSerializer()->toPathValue($packing_slip_template_line_item_description_enum_id),
                $resourcePath
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\Infoplus\Model\PackingSlipTemplateLineItemDescriptionEnum'
            );
            ...
            return array(\Infoplus\ObjectSerializer::deserialize($response, '\Infoplus\Model\PackingSlipTemplateLineItemDescriptionEnum', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \Infoplus\ObjectSerializer::deserialize($e->getResponseBody(), '\Infoplus\Model\PackingSlipTemplateLineItemDescriptionEnum', $e->getResponseHeaders());
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getPackingSlipTemplateLineItemDescriptionEnumBySearchTextWithHttpInfo ($search_text, $page, $limit);
        return $response; 
    }


    /**
     * getPackingSlipTemplateLineItemDescriptionEnumBySearchTextWithHttpInfo
     *
     * Search packingSlipTemplateLineItemDescriptionEnums
     *
     * @param string $search_text Search text, used to filter results. (optional)
