...
class BillingCodeTypeApi
{
    ...
    protected function addBillingCodeTypeRequest($body)
    {
        ...
        $resourcePath = '/v3.0/billingCodeType';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBillingCodeTypeAuditRequest($billing_code_type_id, $billing_code_type_audit)
    {
        ...
        $resourcePath = '/v3.0/billingCodeType/{billingCodeTypeId}/audit/{billingCodeTypeAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBillingCodeTypeFileRequest($billing_code_type_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/billingCodeType/{billingCodeTypeId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBillingCodeTypeFileByURLRequest($body, $billing_code_type_id)
    {
        ...
        $resourcePath = '/v3.0/billingCodeType/{billingCodeTypeId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBillingCodeTypeTagRequest($billing_code_type_id, $billing_code_type_tag)
    {
        ...
        $resourcePath = '/v3.0/billingCodeType/{billingCodeTypeId}/tag/{billingCodeTypeTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteBillingCodeTypeRequest($billing_code_type_id)
    {
        ...
        $resourcePath = '/v3.0/billingCodeType/{billingCodeTypeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteBillingCodeTypeFileRequest($billing_code_type_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/billingCodeType/{billingCodeTypeId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getBillingCodeTypeByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/billingCodeType/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getBillingCodeTypeTagsRequest($billing_code_type_id)
    {
        ...
        $resourcePath = '/v3.0/billingCodeType/{billingCodeTypeId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateBillingCodeTypeByIdRequest($billing_code_type_id)
    {
        ...
        $resourcePath = '/v3.0/billingCodeType/duplicate/{billingCodeTypeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateBillingCodeTypeCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/billingCodeType/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
