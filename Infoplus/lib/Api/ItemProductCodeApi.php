...
class ItemProductCodeApi
{
    ...
    protected function addItemProductCodeRequest($body)
    {
        ...
        $resourcePath = '/v3.0/itemProductCode';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemProductCodeAuditRequest($item_product_code_id, $item_product_code_audit)
    {
        ...
        $resourcePath = '/v3.0/itemProductCode/{itemProductCodeId}/audit/{itemProductCodeAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemProductCodeFileRequest($item_product_code_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/itemProductCode/{itemProductCodeId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemProductCodeFileByURLRequest($body, $item_product_code_id)
    {
        ...
        $resourcePath = '/v3.0/itemProductCode/{itemProductCodeId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemProductCodeTagRequest($item_product_code_id, $item_product_code_tag)
    {
        ...
        $resourcePath = '/v3.0/itemProductCode/{itemProductCodeId}/tag/{itemProductCodeTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemProductCodeRequest($item_product_code_id)
    {
        ...
        $resourcePath = '/v3.0/itemProductCode/{itemProductCodeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemProductCodeFileRequest($item_product_code_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/itemProductCode/{itemProductCodeId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateItemProductCodeByIdRequest($item_product_code_id)
    {
        ...
        $resourcePath = '/v3.0/itemProductCode/duplicate/{itemProductCodeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemProductCodeByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/itemProductCode/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemProductCodeTagsRequest($item_product_code_id)
    {
        ...
        $resourcePath = '/v3.0/itemProductCode/{itemProductCodeId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
