...
class ItemSerialSchemeApi
{
    ...
    protected function addItemSerialSchemeRequest($body)
    {
        ...
        $resourcePath = '/v3.0/itemSerialScheme';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSerialSchemeAuditRequest($item_serial_scheme_id, $item_serial_scheme_audit)
    {
        ...
        $resourcePath = '/v3.0/itemSerialScheme/{itemSerialSchemeId}/audit/{itemSerialSchemeAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSerialSchemeFileRequest($item_serial_scheme_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/itemSerialScheme/{itemSerialSchemeId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSerialSchemeFileByURLRequest($body, $item_serial_scheme_id)
    {
        ...
        $resourcePath = '/v3.0/itemSerialScheme/{itemSerialSchemeId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSerialSchemeTagRequest($item_serial_scheme_id, $item_serial_scheme_tag)
    {
        ...
        $resourcePath = '/v3.0/itemSerialScheme/{itemSerialSchemeId}/tag/{itemSerialSchemeTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemSerialSchemeRequest($item_serial_scheme_id)
    {
        ...
        $resourcePath = '/v3.0/itemSerialScheme/{itemSerialSchemeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemSerialSchemeFileRequest($item_serial_scheme_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/itemSerialScheme/{itemSerialSchemeId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateItemSerialSchemeByIdRequest($item_serial_scheme_id)
    {
        ...
        $resourcePath = '/v3.0/itemSerialScheme/duplicate/{itemSerialSchemeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemSerialSchemeByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/itemSerialScheme/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemSerialSchemeTagsRequest($item_serial_scheme_id)
    {
        ...
        $resourcePath = '/v3.0/itemSerialScheme/{itemSerialSchemeId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
