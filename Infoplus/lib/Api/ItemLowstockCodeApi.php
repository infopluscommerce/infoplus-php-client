...
class ItemLowstockCodeApi
{
    ...
    protected function addItemLowstockCodeRequest($body)
    {
        ...
        $resourcePath = '/v3.0/itemLowstockCode';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemLowstockCodeAuditRequest($item_lowstock_code_id, $item_lowstock_code_audit)
    {
        ...
        $resourcePath = '/v3.0/itemLowstockCode/{itemLowstockCodeId}/audit/{itemLowstockCodeAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemLowstockCodeFileRequest($item_lowstock_code_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/itemLowstockCode/{itemLowstockCodeId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemLowstockCodeFileByURLRequest($body, $item_lowstock_code_id)
    {
        ...
        $resourcePath = '/v3.0/itemLowstockCode/{itemLowstockCodeId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemLowstockCodeTagRequest($item_lowstock_code_id, $item_lowstock_code_tag)
    {
        ...
        $resourcePath = '/v3.0/itemLowstockCode/{itemLowstockCodeId}/tag/{itemLowstockCodeTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemLowstockCodeRequest($item_lowstock_code_id)
    {
        ...
        $resourcePath = '/v3.0/itemLowstockCode/{itemLowstockCodeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemLowstockCodeFileRequest($item_lowstock_code_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/itemLowstockCode/{itemLowstockCodeId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateItemLowstockCodeByIdRequest($item_lowstock_code_id)
    {
        ...
        $resourcePath = '/v3.0/itemLowstockCode/duplicate/{itemLowstockCodeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemLowstockCodeByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/itemLowstockCode/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemLowstockCodeTagsRequest($item_lowstock_code_id)
    {
        ...
        $resourcePath = '/v3.0/itemLowstockCode/{itemLowstockCodeId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
