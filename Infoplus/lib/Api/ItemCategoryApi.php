...
class ItemCategoryApi
{
    ...
    protected function addItemCategoryRequest($body)
    {
        ...
        $resourcePath = '/v3.0/itemCategory';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemCategoryAuditRequest($item_category_id, $item_category_audit)
    {
        ...
        $resourcePath = '/v3.0/itemCategory/{itemCategoryId}/audit/{itemCategoryAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemCategoryFileRequest($item_category_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/itemCategory/{itemCategoryId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemCategoryFileByURLRequest($body, $item_category_id)
    {
        ...
        $resourcePath = '/v3.0/itemCategory/{itemCategoryId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemCategoryTagRequest($item_category_id, $item_category_tag)
    {
        ...
        $resourcePath = '/v3.0/itemCategory/{itemCategoryId}/tag/{itemCategoryTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemCategoryRequest($item_category_id)
    {
        ...
        $resourcePath = '/v3.0/itemCategory/{itemCategoryId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemCategoryFileRequest($item_category_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/itemCategory/{itemCategoryId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateItemCategoryByIdRequest($item_category_id)
    {
        ...
        $resourcePath = '/v3.0/itemCategory/duplicate/{itemCategoryId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemCategoryByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/itemCategory/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemCategoryTagsRequest($item_category_id)
    {
        ...
        $resourcePath = '/v3.0/itemCategory/{itemCategoryId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
