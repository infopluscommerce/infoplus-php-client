...
class OverrideReturnAddressApi
{
    ...
    public function addOverrideReturnAddressWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/overrideReturnAddress";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function deleteOverrideReturnAddressWithHttpInfo($override_return_address_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/overrideReturnAddress/{overrideReturnAddressId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateOverrideReturnAddressByIdWithHttpInfo($override_return_address_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/overrideReturnAddress/duplicate/{overrideReturnAddressId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getOverrideReturnAddressByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/overrideReturnAddress/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateOverrideReturnAddressCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/overrideReturnAddress/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
