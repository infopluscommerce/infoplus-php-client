...
class ItemReceiptApi
{
    ...
    public function getDuplicateItemReceiptByIdWithHttpInfo($item_receipt_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/itemReceipt/duplicate/{itemReceiptId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getItemReceiptByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/itemReceipt/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getItemReceiptByIdWithHttpInfo($item_receipt_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/itemReceipt/{itemReceiptId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateItemReceiptCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/itemReceipt/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
