...
class ItemReceiptApi
{
    ...
    protected function addItemReceiptAuditRequest($item_receipt_id, $item_receipt_audit)
    {
        ...
        $resourcePath = '/v3.0/itemReceipt/{itemReceiptId}/audit/{itemReceiptAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemReceiptFileRequest($item_receipt_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/itemReceipt/{itemReceiptId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemReceiptFileByURLRequest($body, $item_receipt_id)
    {
        ...
        $resourcePath = '/v3.0/itemReceipt/{itemReceiptId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemReceiptTagRequest($item_receipt_id, $item_receipt_tag)
    {
        ...
        $resourcePath = '/v3.0/itemReceipt/{itemReceiptId}/tag/{itemReceiptTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemReceiptFileRequest($item_receipt_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/itemReceipt/{itemReceiptId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateItemReceiptByIdRequest($item_receipt_id)
    {
        ...
        $resourcePath = '/v3.0/itemReceipt/duplicate/{itemReceiptId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemReceiptByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/itemReceipt/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemReceiptByIdRequest($item_receipt_id)
    {
        ...
        $resourcePath = '/v3.0/itemReceipt/{itemReceiptId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemReceiptTagsRequest($item_receipt_id)
    {
        ...
        $resourcePath = '/v3.0/itemReceipt/{itemReceiptId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateItemReceiptCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/itemReceipt/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
