...
class OmsOrderApi
{
    ...
    protected function addOmsOrderAuditRequest($oms_order_id, $oms_order_audit)
    {
        ...
        $resourcePath = '/v3.0/omsOrder/{omsOrderId}/audit/{omsOrderAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOmsOrderFileRequest($oms_order_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/omsOrder/{omsOrderId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOmsOrderFileByURLRequest($body, $oms_order_id)
    {
        ...
        $resourcePath = '/v3.0/omsOrder/{omsOrderId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOmsOrderTagRequest($oms_order_id, $oms_order_tag)
    {
        ...
        $resourcePath = '/v3.0/omsOrder/{omsOrderId}/tag/{omsOrderTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteOmsOrderFileRequest($oms_order_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/omsOrder/{omsOrderId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateOmsOrderByIdRequest($oms_order_id)
    {
        ...
        $resourcePath = '/v3.0/omsOrder/duplicate/{omsOrderId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getOmsOrderByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/omsOrder/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getOmsOrderByIdRequest($oms_order_id)
    {
        ...
        $resourcePath = '/v3.0/omsOrder/{omsOrderId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getOmsOrderTagsRequest($oms_order_id)
    {
        ...
        $resourcePath = '/v3.0/omsOrder/{omsOrderId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateOmsOrderCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/omsOrder/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
