...
class VendorApi
{
    ...
    protected function addVendorAuditRequest($vendor_id, $vendor_audit)
    {
        ...
        $resourcePath = '/v3.0/vendor/{vendorId}/audit/{vendorAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addVendorFileRequest($vendor_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/vendor/{vendorId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addVendorFileByURLRequest($body, $vendor_id)
    {
        ...
        $resourcePath = '/v3.0/vendor/{vendorId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addVendorTagRequest($vendor_id, $vendor_tag)
    {
        ...
        $resourcePath = '/v3.0/vendor/{vendorId}/tag/{vendorTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteVendorRequest($vendor_id)
    {
        ...
        $resourcePath = '/v3.0/vendor/{vendorId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteVendorFileRequest($vendor_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/vendor/{vendorId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateVendorByIdRequest($vendor_id)
    {
        ...
        $resourcePath = '/v3.0/vendor/duplicate/{vendorId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getVendorByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/vendor/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getVendorTagsRequest($vendor_id)
    {
        ...
        $resourcePath = '/v3.0/vendor/{vendorId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateVendorCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/vendor/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
