...
class EmailTemplateApi
{
    ...
    protected function addEmailTemplateRequest($body)
    {
        ...
        $resourcePath = '/v3.0/emailTemplate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addEmailTemplateAuditRequest($email_template_id, $email_template_audit)
    {
        ...
        $resourcePath = '/v3.0/emailTemplate/{emailTemplateId}/audit/{emailTemplateAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addEmailTemplateFileRequest($email_template_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/emailTemplate/{emailTemplateId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addEmailTemplateFileByURLRequest($body, $email_template_id)
    {
        ...
        $resourcePath = '/v3.0/emailTemplate/{emailTemplateId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addEmailTemplateTagRequest($email_template_id, $email_template_tag)
    {
        ...
        $resourcePath = '/v3.0/emailTemplate/{emailTemplateId}/tag/{emailTemplateTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteEmailTemplateRequest($email_template_id)
    {
        ...
        $resourcePath = '/v3.0/emailTemplate/{emailTemplateId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteEmailTemplateFileRequest($email_template_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/emailTemplate/{emailTemplateId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateEmailTemplateByIdRequest($email_template_id)
    {
        ...
        $resourcePath = '/v3.0/emailTemplate/duplicate/{emailTemplateId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getEmailTemplateByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/emailTemplate/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getEmailTemplateTagsRequest($email_template_id)
    {
        ...
        $resourcePath = '/v3.0/emailTemplate/{emailTemplateId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateEmailTemplateCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/emailTemplate/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
