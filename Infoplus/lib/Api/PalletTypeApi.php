...
class PalletTypeApi
{
    ...
    protected function addPalletTypeAuditRequest($pallet_type_id, $pallet_type_audit)
    {
        ...
        $resourcePath = '/v3.0/palletType/{palletTypeId}/audit/{palletTypeAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addPalletTypeFileRequest($pallet_type_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/palletType/{palletTypeId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addPalletTypeFileByURLRequest($body, $pallet_type_id)
    {
        ...
        $resourcePath = '/v3.0/palletType/{palletTypeId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addPalletTypeTagRequest($pallet_type_id, $pallet_type_tag)
    {
        ...
        $resourcePath = '/v3.0/palletType/{palletTypeId}/tag/{palletTypeTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deletePalletTypeRequest($pallet_type_id)
    {
        ...
        $resourcePath = '/v3.0/palletType/{palletTypeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deletePalletTypeFileRequest($pallet_type_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/palletType/{palletTypeId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicatePalletTypeByIdRequest($pallet_type_id)
    {
        ...
        $resourcePath = '/v3.0/palletType/duplicate/{palletTypeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getPalletTypeByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/palletType/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getPalletTypeTagsRequest($pallet_type_id)
    {
        ...
        $resourcePath = '/v3.0/palletType/{palletTypeId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updatePalletTypeCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/palletType/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
