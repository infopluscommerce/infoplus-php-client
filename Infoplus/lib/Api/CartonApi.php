...
class CartonApi
{
    ...
    protected function addCartonAuditRequest($carton_id, $carton_audit)
    {
        ...
        $resourcePath = '/v3.0/carton/{cartonId}/audit/{cartonAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonFileRequest($carton_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/carton/{cartonId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonFileByURLRequest($body, $carton_id)
    {
        ...
        $resourcePath = '/v3.0/carton/{cartonId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonTagRequest($carton_id, $carton_tag)
    {
        ...
        $resourcePath = '/v3.0/carton/{cartonId}/tag/{cartonTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteCartonRequest($carton_id)
    {
        ...
        $resourcePath = '/v3.0/carton/{cartonId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteCartonFileRequest($carton_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/carton/{cartonId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCartonByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/carton/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCartonTagsRequest($carton_id)
    {
        ...
        $resourcePath = '/v3.0/carton/{cartonId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateCartonByIdRequest($carton_id)
    {
        ...
        $resourcePath = '/v3.0/carton/duplicate/{cartonId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateCartonCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/carton/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
