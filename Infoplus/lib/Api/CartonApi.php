...
class CartonApi
{
    ...
    public function deleteCartonWithHttpInfo($carton_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/carton/{cartonId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getCartonByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/carton/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateCartonByIdWithHttpInfo($carton_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/carton/duplicate/{cartonId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateCartonCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/carton/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
