...
class ManageScheduledPlansApi
{
    ...
    protected function addManageScheduledPlansRequest($body)
    {
        ...
        $resourcePath = '/v3.0/manageScheduledPlans';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addManageScheduledPlansAuditRequest($manage_scheduled_plans_id, $manage_scheduled_plans_audit)
    {
        ...
        $resourcePath = '/v3.0/manageScheduledPlans/{manageScheduledPlansId}/audit/{manageScheduledPlansAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addManageScheduledPlansFileRequest($manage_scheduled_plans_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/manageScheduledPlans/{manageScheduledPlansId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addManageScheduledPlansFileByURLRequest($body, $manage_scheduled_plans_id)
    {
        ...
        $resourcePath = '/v3.0/manageScheduledPlans/{manageScheduledPlansId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addManageScheduledPlansTagRequest($manage_scheduled_plans_id, $manage_scheduled_plans_tag)
    {
        ...
        $resourcePath = '/v3.0/manageScheduledPlans/{manageScheduledPlansId}/tag/{manageScheduledPlansTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteManageScheduledPlansRequest($manage_scheduled_plans_id)
    {
        ...
        $resourcePath = '/v3.0/manageScheduledPlans/{manageScheduledPlansId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteManageScheduledPlansFileRequest($manage_scheduled_plans_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/manageScheduledPlans/{manageScheduledPlansId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateManageScheduledPlansByIdRequest($manage_scheduled_plans_id)
    {
        ...
        $resourcePath = '/v3.0/manageScheduledPlans/duplicate/{manageScheduledPlansId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getManageScheduledPlansByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/manageScheduledPlans/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getManageScheduledPlansTagsRequest($manage_scheduled_plans_id)
    {
        ...
        $resourcePath = '/v3.0/manageScheduledPlans/{manageScheduledPlansId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
