...
class ManageScheduledPlansApi
{
    ...
    public function addManageScheduledPlansWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/manageScheduledPlans";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function deleteManageScheduledPlansWithHttpInfo($manage_scheduled_plans_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/manageScheduledPlans/{manageScheduledPlansId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateManageScheduledPlansByIdWithHttpInfo($manage_scheduled_plans_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/manageScheduledPlans/duplicate/{manageScheduledPlansId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getManageScheduledPlansByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/manageScheduledPlans/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
