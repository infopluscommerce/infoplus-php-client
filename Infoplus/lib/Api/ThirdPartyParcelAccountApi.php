...
class ThirdPartyParcelAccountApi
{
     ...
     * @return ThirdPartyParcelAccountApi
     */
     ...
     *
     * @param \Infoplus\Model\ThirdPartyParcelAccount $body ThirdPartyParcelAccount to be inserted. (required)
     * @return \Infoplus\Model\ThirdPartyParcelAccount
     * @throws \Infoplus\ApiException on non-2xx response
     */
    public function addThirdPartyParcelAccount($body)
    {
        list($response, $statusCode, $httpHeader) = $this->addThirdPartyParcelAccountWithHttpInfo ($body);
        return $response; 
    }


    /**
     * addThirdPartyParcelAccountWithHttpInfo
     *
     * Create a thirdPartyParcelAccount
     *
     * @param \Infoplus\Model\ThirdPartyParcelAccount $body ThirdPartyParcelAccount to be inserted. (required)
    ...
    public function addThirdPartyParcelAccountWithHttpInfo($body)
    {
        ...
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling addThirdPartyParcelAccount');
        }
  
        // parse inputs
        $resourcePath = "/v2.0/thirdPartyParcelAccount";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->deleteThirdPartyParcelAccountWithHttpInfo ($third_party_parcel_account_id);
        return $response; 
    }


    /**
     * deleteThirdPartyParcelAccountWithHttpInfo
     *
     * Delete a thirdPartyParcelAccount
     *
     * @param int $third_party_parcel_account_id Id of the thirdPartyParcelAccount to be deleted. (required)
    ...
    public function deleteThirdPartyParcelAccountWithHttpInfo($third_party_parcel_account_id)
    {
        ...
        if ($third_party_parcel_account_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $third_party_parcel_account_id when calling deleteThirdPartyParcelAccount');
        }
  
        // parse inputs
        $resourcePath = "/v2.0/thirdPartyParcelAccount/{thirdPartyParcelAccountId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateThirdPartyParcelAccountByIdWithHttpInfo($third_party_parcel_account_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/thirdPartyParcelAccount/duplicate/{thirdPartyParcelAccountId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getThirdPartyParcelAccountByFilterWithHttpInfo ($filter, $page, $limit, $sort);
        return $response; 
    }


    /**
     * getThirdPartyParcelAccountByFilterWithHttpInfo
     *
     * Search thirdPartyParcelAccounts by filter
     *
     * @param string $filter Query string, used to filter results. (optional)
    ...
    public function getThirdPartyParcelAccountByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/thirdPartyParcelAccount/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getThirdPartyParcelAccountByIdWithHttpInfo ($third_party_parcel_account_id);
        return $response; 
    }


    /**
     * getThirdPartyParcelAccountByIdWithHttpInfo
     *
     * Get a thirdPartyParcelAccount by id
     *
     * @param int $third_party_parcel_account_id Id of the thirdPartyParcelAccount to be returned. (required)
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->updateThirdPartyParcelAccountWithHttpInfo ($body);
        return $response; 
    }


    /**
     * updateThirdPartyParcelAccountWithHttpInfo
     *
     * Update a thirdPartyParcelAccount
     *
     * @param \Infoplus\Model\ThirdPartyParcelAccount $body ThirdPartyParcelAccount to be updated. (required)
    ...
    public function updateThirdPartyParcelAccountWithHttpInfo($body)
    {
        ...
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling updateThirdPartyParcelAccount');
        }
    ...
    public function updateThirdPartyParcelAccountCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/thirdPartyParcelAccount/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
