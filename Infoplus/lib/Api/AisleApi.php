...
class AisleApi
{
    ...
    protected function addAisleAuditRequest($aisle_id, $aisle_audit)
    {
        ...
        $resourcePath = '/v3.0/aisle/{aisleId}/audit/{aisleAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addAisleFileRequest($aisle_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/aisle/{aisleId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addAisleFileByURLRequest($body, $aisle_id)
    {
        ...
        $resourcePath = '/v3.0/aisle/{aisleId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addAisleTagRequest($aisle_id, $aisle_tag)
    {
        ...
        $resourcePath = '/v3.0/aisle/{aisleId}/tag/{aisleTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteAisleRequest($aisle_id)
    {
        ...
        $resourcePath = '/v3.0/aisle/{aisleId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteAisleFileRequest($aisle_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/aisle/{aisleId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getAisleByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/aisle/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getAisleTagsRequest($aisle_id)
    {
        ...
        $resourcePath = '/v3.0/aisle/{aisleId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateAisleByIdRequest($aisle_id)
    {
        ...
        $resourcePath = '/v3.0/aisle/duplicate/{aisleId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateAisleCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/aisle/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
