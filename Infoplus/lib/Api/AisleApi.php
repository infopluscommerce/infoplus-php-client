...
class AisleApi
{
    ...
    public function deleteAisleWithHttpInfo($aisle_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/aisle/{aisleId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getAisleByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/aisle/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateAisleByIdWithHttpInfo($aisle_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/aisle/duplicate/{aisleId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateAisleCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/aisle/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
