...
class WorkActivityApi
{
    ...
    protected function addWorkActivityRequest($body)
    {
        ...
        $resourcePath = '/v3.0/workActivity';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addWorkActivityAuditRequest($work_activity_id, $work_activity_audit)
    {
        ...
        $resourcePath = '/v3.0/workActivity/{workActivityId}/audit/{workActivityAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addWorkActivityFileRequest($work_activity_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/workActivity/{workActivityId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addWorkActivityFileByURLRequest($body, $work_activity_id)
    {
        ...
        $resourcePath = '/v3.0/workActivity/{workActivityId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addWorkActivityTagRequest($work_activity_id, $work_activity_tag)
    {
        ...
        $resourcePath = '/v3.0/workActivity/{workActivityId}/tag/{workActivityTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteWorkActivityRequest($work_activity_id)
    {
        ...
        $resourcePath = '/v3.0/workActivity/{workActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteWorkActivityFileRequest($work_activity_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/workActivity/{workActivityId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateWorkActivityByIdRequest($work_activity_id)
    {
        ...
        $resourcePath = '/v3.0/workActivity/duplicate/{workActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getWorkActivityByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/workActivity/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getWorkActivityTagsRequest($work_activity_id)
    {
        ...
        $resourcePath = '/v3.0/workActivity/{workActivityId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
