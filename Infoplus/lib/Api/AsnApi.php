...
class AsnApi
{
    ...
    protected function addAsnAuditRequest($asn_id, $asn_audit)
    {
        ...
        $resourcePath = '/v3.0/asn/{asnId}/audit/{asnAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addAsnFileRequest($asn_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/asn/{asnId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addAsnFileByURLRequest($body, $asn_id)
    {
        ...
        $resourcePath = '/v3.0/asn/{asnId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addAsnTagRequest($asn_id, $asn_tag)
    {
        ...
        $resourcePath = '/v3.0/asn/{asnId}/tag/{asnTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteAsnFileRequest($asn_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/asn/{asnId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getAsnTagsRequest($asn_id)
    {
        ...
        $resourcePath = '/v3.0/asn/{asnId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateAsnByIdRequest($asn_id)
    {
        ...
        $resourcePath = '/v3.0/asn/duplicate/{asnId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateAsnCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/asn/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
