...
class AsnApi
{
     ...
     *
     * @param  \Infoplus\Infoplus\Model\ClosePurchProcessInputAPIModel $body Input data for ClosePurchProcess process. (required)
     *
     * @throws \Infoplus\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Infoplus\Infoplus\Model\ProcessOutputAPIModel[]
     */
    public function closeAsn($body)
    {
        list($response) = $this->closeAsnWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation closeAsnWithHttpInfo
     *
     * Run the ClosePurchProcess process.
     *
     * @param  \Infoplus\Infoplus\Model\ClosePurchProcessInputAPIModel $body Input data for ClosePurchProcess process. (required)
     ...
     */
    public function closeAsnWithHttpInfo($body)
    {
        $returnType = '\Infoplus\Infoplus\Model\ProcessOutputAPIModel[]';
        $request = $this->closeAsnRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function closeAsnAsync($body)
    {
        return $this->closeAsnAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation closeAsnAsyncWithHttpInfo
     *
     * Run the ClosePurchProcess process.
     *
     * @param  \Infoplus\Infoplus\Model\ClosePurchProcessInputAPIModel $body Input data for ClosePurchProcess process. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function closeAsnAsyncWithHttpInfo($body)
    {
        $returnType = '\Infoplus\Infoplus\Model\ProcessOutputAPIModel[]';
        $request = $this->closeAsnRequest($body);
    ...
    /**
     * Create request for operation 'closeAsn'
     *
     * @param  \Infoplus\Infoplus\Model\ClosePurchProcessInputAPIModel $body Input data for ClosePurchProcess process. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function closeAsnRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling closeAsn'
            );
        }

        $resourcePath = '/beta/asn/closeAsn';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
