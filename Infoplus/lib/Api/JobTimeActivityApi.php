...
class JobTimeActivityApi
{
    ...
    protected function addJobTimeActivityRequest($body)
    {
        ...
        $resourcePath = '/v3.0/jobTimeActivity';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addJobTimeActivityAuditRequest($job_time_activity_id, $job_time_activity_audit)
    {
        ...
        $resourcePath = '/v3.0/jobTimeActivity/{jobTimeActivityId}/audit/{jobTimeActivityAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addJobTimeActivityFileRequest($job_time_activity_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/jobTimeActivity/{jobTimeActivityId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addJobTimeActivityFileByURLRequest($body, $job_time_activity_id)
    {
        ...
        $resourcePath = '/v3.0/jobTimeActivity/{jobTimeActivityId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addJobTimeActivityTagRequest($job_time_activity_id, $job_time_activity_tag)
    {
        ...
        $resourcePath = '/v3.0/jobTimeActivity/{jobTimeActivityId}/tag/{jobTimeActivityTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteJobTimeActivityRequest($job_time_activity_id)
    {
        ...
        $resourcePath = '/v3.0/jobTimeActivity/{jobTimeActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteJobTimeActivityFileRequest($job_time_activity_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/jobTimeActivity/{jobTimeActivityId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateJobTimeActivityByIdRequest($job_time_activity_id)
    {
        ...
        $resourcePath = '/v3.0/jobTimeActivity/duplicate/{jobTimeActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getJobTimeActivityByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/jobTimeActivity/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getJobTimeActivityTagsRequest($job_time_activity_id)
    {
        ...
        $resourcePath = '/v3.0/jobTimeActivity/{jobTimeActivityId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
