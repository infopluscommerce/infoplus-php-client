...
class CartonActivityApi
{
    ...
    protected function addCartonActivityRequest($body)
    {
        ...
        $resourcePath = '/v3.0/cartonActivity';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonActivityAuditRequest($carton_activity_id, $carton_activity_audit)
    {
        ...
        $resourcePath = '/v3.0/cartonActivity/{cartonActivityId}/audit/{cartonActivityAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonActivityFileRequest($carton_activity_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/cartonActivity/{cartonActivityId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonActivityFileByURLRequest($body, $carton_activity_id)
    {
        ...
        $resourcePath = '/v3.0/cartonActivity/{cartonActivityId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonActivityTagRequest($carton_activity_id, $carton_activity_tag)
    {
        ...
        $resourcePath = '/v3.0/cartonActivity/{cartonActivityId}/tag/{cartonActivityTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteCartonActivityRequest($carton_activity_id)
    {
        ...
        $resourcePath = '/v3.0/cartonActivity/{cartonActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteCartonActivityFileRequest($carton_activity_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/cartonActivity/{cartonActivityId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCartonActivityByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/cartonActivity/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCartonActivityTagsRequest($carton_activity_id)
    {
        ...
        $resourcePath = '/v3.0/cartonActivity/{cartonActivityId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateCartonActivityByIdRequest($carton_activity_id)
    {
        ...
        $resourcePath = '/v3.0/cartonActivity/duplicate/{cartonActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
