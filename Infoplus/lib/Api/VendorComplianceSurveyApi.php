...
class VendorComplianceSurveyApi
{
    ...
    public function addVendorComplianceSurveyWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/vendorComplianceSurvey";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function deleteVendorComplianceSurveyWithHttpInfo($vendor_compliance_survey_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/vendorComplianceSurvey/{vendorComplianceSurveyId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateVendorComplianceSurveyByIdWithHttpInfo($vendor_compliance_survey_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/vendorComplianceSurvey/duplicate/{vendorComplianceSurveyId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getVendorComplianceSurveyByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/vendorComplianceSurvey/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateVendorComplianceSurveyCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/vendorComplianceSurvey/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
