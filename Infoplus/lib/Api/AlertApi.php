...
class AlertApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getAlertByFilterWithHttpInfo ($filter, $page, $limit, $sort);
        return $response; 
    }


    /**
     * getAlertByFilterWithHttpInfo
     *
     * Search alerts by filter
     *
     * @param string $filter Query string, used to filter results. (optional)
    ...
    public function getAlertByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/alert/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getAlertByIdWithHttpInfo ($alert_id);
        return $response; 
    }


    /**
     * getAlertByIdWithHttpInfo
     *
     * Get an alert by id
     *
     * @param int $alert_id Id of the alert to be returned. (required)
    ...
    public function getAlertByIdWithHttpInfo($alert_id)
    {
        ...
        if ($alert_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $alert_id when calling getAlertById');
        }
  
        // parse inputs
        $resourcePath = "/v2.0/alert/{alertId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateAlertByIdWithHttpInfo($alert_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/alert/duplicate/{alertId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateAlertCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/alert/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
