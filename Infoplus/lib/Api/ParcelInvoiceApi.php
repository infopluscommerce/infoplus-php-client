...
class ParcelInvoiceApi
{
    ...
    protected function addParcelInvoiceAuditRequest($parcel_invoice_id, $parcel_invoice_audit)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoice/{parcelInvoiceId}/audit/{parcelInvoiceAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addParcelInvoiceFileRequest($parcel_invoice_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoice/{parcelInvoiceId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addParcelInvoiceFileByURLRequest($body, $parcel_invoice_id)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoice/{parcelInvoiceId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addParcelInvoiceTagRequest($parcel_invoice_id, $parcel_invoice_tag)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoice/{parcelInvoiceId}/tag/{parcelInvoiceTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteParcelInvoiceRequest($parcel_invoice_id)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoice/{parcelInvoiceId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteParcelInvoiceFileRequest($parcel_invoice_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoice/{parcelInvoiceId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateParcelInvoiceByIdRequest($parcel_invoice_id)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoice/duplicate/{parcelInvoiceId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getParcelInvoiceByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoice/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getParcelInvoiceTagsRequest($parcel_invoice_id)
    {
        ...
        $resourcePath = '/v3.0/parcelInvoice/{parcelInvoiceId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
