...
class NonBusinessDayApi
{
    ...
    protected function addNonBusinessDayRequest($body)
    {
        ...
        $resourcePath = '/v3.0/nonBusinessDay';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addNonBusinessDayAuditRequest($non_business_day_id, $non_business_day_audit)
    {
        ...
        $resourcePath = '/v3.0/nonBusinessDay/{nonBusinessDayId}/audit/{nonBusinessDayAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addNonBusinessDayFileRequest($non_business_day_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/nonBusinessDay/{nonBusinessDayId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addNonBusinessDayFileByURLRequest($body, $non_business_day_id)
    {
        ...
        $resourcePath = '/v3.0/nonBusinessDay/{nonBusinessDayId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addNonBusinessDayTagRequest($non_business_day_id, $non_business_day_tag)
    {
        ...
        $resourcePath = '/v3.0/nonBusinessDay/{nonBusinessDayId}/tag/{nonBusinessDayTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteNonBusinessDayRequest($non_business_day_id)
    {
        ...
        $resourcePath = '/v3.0/nonBusinessDay/{nonBusinessDayId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteNonBusinessDayFileRequest($non_business_day_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/nonBusinessDay/{nonBusinessDayId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateNonBusinessDayByIdRequest($non_business_day_id)
    {
        ...
        $resourcePath = '/v3.0/nonBusinessDay/duplicate/{nonBusinessDayId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getNonBusinessDayByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/nonBusinessDay/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getNonBusinessDayTagsRequest($non_business_day_id)
    {
        ...
        $resourcePath = '/v3.0/nonBusinessDay/{nonBusinessDayId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
