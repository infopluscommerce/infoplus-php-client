...
class ReplenishmentPlanApi
{
    ...
    protected function addReplenishmentPlanRequest($body)
    {
        ...
        $resourcePath = '/v3.0/replenishmentPlan';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReplenishmentPlanAuditRequest($replenishment_plan_id, $replenishment_plan_audit)
    {
        ...
        $resourcePath = '/v3.0/replenishmentPlan/{replenishmentPlanId}/audit/{replenishmentPlanAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReplenishmentPlanFileRequest($replenishment_plan_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/replenishmentPlan/{replenishmentPlanId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReplenishmentPlanFileByURLRequest($body, $replenishment_plan_id)
    {
        ...
        $resourcePath = '/v3.0/replenishmentPlan/{replenishmentPlanId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReplenishmentPlanTagRequest($replenishment_plan_id, $replenishment_plan_tag)
    {
        ...
        $resourcePath = '/v3.0/replenishmentPlan/{replenishmentPlanId}/tag/{replenishmentPlanTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteReplenishmentPlanRequest($replenishment_plan_id)
    {
        ...
        $resourcePath = '/v3.0/replenishmentPlan/{replenishmentPlanId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteReplenishmentPlanFileRequest($replenishment_plan_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/replenishmentPlan/{replenishmentPlanId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateReplenishmentPlanByIdRequest($replenishment_plan_id)
    {
        ...
        $resourcePath = '/v3.0/replenishmentPlan/duplicate/{replenishmentPlanId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getReplenishmentPlanByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/replenishmentPlan/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getReplenishmentPlanTagsRequest($replenishment_plan_id)
    {
        ...
        $resourcePath = '/v3.0/replenishmentPlan/{replenishmentPlanId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateReplenishmentPlanCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/replenishmentPlan/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
