...
class WarehouseApi
{
    ...
    public function getDuplicateWarehouseByIdWithHttpInfo($warehouse_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/warehouse/duplicate/{warehouseId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getWarehouseByFilterWithHttpInfo ($filter, $page, $limit, $sort);
        return $response; 
    }


    /**
     * getWarehouseByFilterWithHttpInfo
     *
     * Search warehouses by filter
     *
     * @param string $filter Query string, used to filter results. (optional)
    ...
    public function getWarehouseByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/warehouse/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getWarehouseByIdWithHttpInfo ($warehouse_id);
        return $response; 
    }


    /**
     * getWarehouseByIdWithHttpInfo
     *
     * Get a warehouse by id
     *
     * @param int $warehouse_id Id of the warehouse to be returned. (required)
    ...
    public function getWarehouseByIdWithHttpInfo($warehouse_id)
    {
        ...
        // verify the required parameter 'warehouse_id' is set
        if ($warehouse_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $warehouse_id when calling getWarehouseById');
        }
  
        // parse inputs
        $resourcePath = "/v2.0/warehouse/{warehouseId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->updateWarehouseWithHttpInfo ($body);
        return $response; 
    }


    /**
     * updateWarehouseWithHttpInfo
     *
     * Update a warehouse
     *
     * @param \Infoplus\Model\Warehouse $body Warehouse to be updated. (required)
    ...
    public function updateWarehouseWithHttpInfo($body)
    {
        ...
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling updateWarehouse');
        }
  
        // parse inputs
        $resourcePath = "/v2.0/warehouse";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateWarehouseCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/warehouse/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
