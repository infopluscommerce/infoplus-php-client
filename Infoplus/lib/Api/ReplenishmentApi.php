...
class ReplenishmentApi
{
    ...
    protected function addReplenishmentAuditRequest($replenishment_id, $replenishment_audit)
    {
        ...
        $resourcePath = '/v3.0/replenishment/{replenishmentId}/audit/{replenishmentAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReplenishmentFileRequest($replenishment_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/replenishment/{replenishmentId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReplenishmentFileByURLRequest($body, $replenishment_id)
    {
        ...
        $resourcePath = '/v3.0/replenishment/{replenishmentId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addReplenishmentTagRequest($replenishment_id, $replenishment_tag)
    {
        ...
        $resourcePath = '/v3.0/replenishment/{replenishmentId}/tag/{replenishmentTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteReplenishmentFileRequest($replenishment_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/replenishment/{replenishmentId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateReplenishmentByIdRequest($replenishment_id)
    {
        ...
        $resourcePath = '/v3.0/replenishment/duplicate/{replenishmentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getReplenishmentByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/replenishment/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getReplenishmentByIdRequest($replenishment_id)
    {
        ...
        $resourcePath = '/v3.0/replenishment/{replenishmentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getReplenishmentTagsRequest($replenishment_id)
    {
        ...
        $resourcePath = '/v3.0/replenishment/{replenishmentId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateReplenishmentCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/replenishment/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
