...
class FulfillmentProcessApi
{
    ...
    public function getDuplicateFulfillmentProcessByIdWithHttpInfo($fulfillment_process_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/fulfillmentProcess/duplicate/{fulfillmentProcessId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getFulfillmentProcessByFilterWithHttpInfo ($filter, $page, $limit, $sort);
        return $response; 
    }


    /**
     * getFulfillmentProcessByFilterWithHttpInfo
     *
     * Search fulfillmentProcesses by filter
     *
     * @param string $filter Query string, used to filter results. (optional)
    ...
    public function getFulfillmentProcessByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/fulfillmentProcess/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getFulfillmentProcessByIdWithHttpInfo ($fulfillment_process_id);
        return $response; 
    }


    /**
     * getFulfillmentProcessByIdWithHttpInfo
     *
     * Get a fulfillmentProcess by id
     *
     * @param int $fulfillment_process_id Id of the fulfillmentProcess to be returned. (required)
    ...
    public function getFulfillmentProcessByIdWithHttpInfo($fulfillment_process_id)
    {
        ...
        // verify the required parameter 'fulfillment_process_id' is set
        if ($fulfillment_process_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $fulfillment_process_id when calling getFulfillmentProcessById');
        }
  
        // parse inputs
        $resourcePath = "/v2.0/fulfillmentProcess/{fulfillmentProcessId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateFulfillmentProcessCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/fulfillmentProcess/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
