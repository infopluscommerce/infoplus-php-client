...
class OrderSourceStockStatusApi
{
    ...
    protected function addOrderSourceStockStatusAuditRequest($order_source_stock_status_id, $order_source_stock_status_audit)
    {
        ...
        $resourcePath = '/v3.0/orderSourceStockStatus/{orderSourceStockStatusId}/audit/{orderSourceStockStatusAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderSourceStockStatusFileRequest($order_source_stock_status_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/orderSourceStockStatus/{orderSourceStockStatusId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderSourceStockStatusFileByURLRequest($body, $order_source_stock_status_id)
    {
        ...
        $resourcePath = '/v3.0/orderSourceStockStatus/{orderSourceStockStatusId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addOrderSourceStockStatusTagRequest($order_source_stock_status_id, $order_source_stock_status_tag)
    {
        ...
        $resourcePath = '/v3.0/orderSourceStockStatus/{orderSourceStockStatusId}/tag/{orderSourceStockStatusTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteOrderSourceStockStatusFileRequest($order_source_stock_status_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/orderSourceStockStatus/{orderSourceStockStatusId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateOrderSourceStockStatusByIdRequest($order_source_stock_status_id)
    {
        ...
        $resourcePath = '/v3.0/orderSourceStockStatus/duplicate/{orderSourceStockStatusId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getOrderSourceStockStatusByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/orderSourceStockStatus/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getOrderSourceStockStatusByIdRequest($order_source_stock_status_id)
    {
        ...
        $resourcePath = '/v3.0/orderSourceStockStatus/{orderSourceStockStatusId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getOrderSourceStockStatusTagsRequest($order_source_stock_status_id)
    {
        ...
        $resourcePath = '/v3.0/orderSourceStockStatus/{orderSourceStockStatusId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
