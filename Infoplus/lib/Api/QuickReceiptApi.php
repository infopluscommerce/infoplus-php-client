...
class QuickReceiptApi
{
    ...
    protected function addQuickReceiptRequest($body)
    {
        ...
        $resourcePath = '/v3.0/quickReceipt';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addQuickReceiptAuditRequest($quick_receipt_id, $quick_receipt_audit)
    {
        ...
        $resourcePath = '/v3.0/quickReceipt/{quickReceiptId}/audit/{quickReceiptAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addQuickReceiptFileRequest($quick_receipt_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/quickReceipt/{quickReceiptId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addQuickReceiptFileByURLRequest($body, $quick_receipt_id)
    {
        ...
        $resourcePath = '/v3.0/quickReceipt/{quickReceiptId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addQuickReceiptTagRequest($quick_receipt_id, $quick_receipt_tag)
    {
        ...
        $resourcePath = '/v3.0/quickReceipt/{quickReceiptId}/tag/{quickReceiptTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteQuickReceiptRequest($quick_receipt_id)
    {
        ...
        $resourcePath = '/v3.0/quickReceipt/{quickReceiptId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteQuickReceiptFileRequest($quick_receipt_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/quickReceipt/{quickReceiptId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function executeQuickReceiptRequest($body)
    {
        ...
        $resourcePath = '/v3.0/quickReceipt/executeQuickReceipt';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateQuickReceiptByIdRequest($quick_receipt_id)
    {
        ...
        $resourcePath = '/v3.0/quickReceipt/duplicate/{quickReceiptId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getQuickReceiptByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/quickReceipt/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getQuickReceiptTagsRequest($quick_receipt_id)
    {
        ...
        $resourcePath = '/v3.0/quickReceipt/{quickReceiptId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateQuickReceiptCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/quickReceipt/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
