...
class BillingCodeActivityApi
{
    ...
    protected function addBillingCodeActivityRequest($body)
    {
        ...
        $resourcePath = '/v3.0/billingCodeActivity';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBillingCodeActivityAuditRequest($billing_code_activity_id, $billing_code_activity_audit)
    {
        ...
        $resourcePath = '/v3.0/billingCodeActivity/{billingCodeActivityId}/audit/{billingCodeActivityAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBillingCodeActivityFileRequest($billing_code_activity_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/billingCodeActivity/{billingCodeActivityId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBillingCodeActivityFileByURLRequest($body, $billing_code_activity_id)
    {
        ...
        $resourcePath = '/v3.0/billingCodeActivity/{billingCodeActivityId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBillingCodeActivityTagRequest($billing_code_activity_id, $billing_code_activity_tag)
    {
        ...
        $resourcePath = '/v3.0/billingCodeActivity/{billingCodeActivityId}/tag/{billingCodeActivityTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteBillingCodeActivityRequest($billing_code_activity_id)
    {
        ...
        $resourcePath = '/v3.0/billingCodeActivity/{billingCodeActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteBillingCodeActivityFileRequest($billing_code_activity_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/billingCodeActivity/{billingCodeActivityId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getBillingCodeActivityByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/billingCodeActivity/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getBillingCodeActivityTagsRequest($billing_code_activity_id)
    {
        ...
        $resourcePath = '/v3.0/billingCodeActivity/{billingCodeActivityId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateBillingCodeActivityByIdRequest($billing_code_activity_id)
    {
        ...
        $resourcePath = '/v3.0/billingCodeActivity/duplicate/{billingCodeActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
