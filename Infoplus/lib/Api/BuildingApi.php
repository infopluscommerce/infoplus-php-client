...
class BuildingApi
{
    ...
    protected function addBuildingAuditRequest($building_id, $building_audit)
    {
        ...
        $resourcePath = '/v3.0/building/{buildingId}/audit/{buildingAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBuildingFileRequest($building_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/building/{buildingId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBuildingFileByURLRequest($body, $building_id)
    {
        ...
        $resourcePath = '/v3.0/building/{buildingId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addBuildingTagRequest($building_id, $building_tag)
    {
        ...
        $resourcePath = '/v3.0/building/{buildingId}/tag/{buildingTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteBuildingRequest($building_id)
    {
        ...
        $resourcePath = '/v3.0/building/{buildingId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteBuildingFileRequest($building_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/building/{buildingId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getBuildingByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/building/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getBuildingTagsRequest($building_id)
    {
        ...
        $resourcePath = '/v3.0/building/{buildingId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateBuildingByIdRequest($building_id)
    {
        ...
        $resourcePath = '/v3.0/building/duplicate/{buildingId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateBuildingCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/building/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
