...
class InventoryStorageActivityApi
{
    ...
    protected function addInventoryStorageActivityRequest($body)
    {
        ...
        $resourcePath = '/v3.0/inventoryStorageActivity';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInventoryStorageActivityAuditRequest($inventory_storage_activity_id, $inventory_storage_activity_audit)
    {
        ...
        $resourcePath = '/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/audit/{inventoryStorageActivityAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInventoryStorageActivityFileRequest($inventory_storage_activity_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInventoryStorageActivityFileByURLRequest($body, $inventory_storage_activity_id)
    {
        ...
        $resourcePath = '/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInventoryStorageActivityTagRequest($inventory_storage_activity_id, $inventory_storage_activity_tag)
    {
        ...
        $resourcePath = '/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/tag/{inventoryStorageActivityTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteInventoryStorageActivityRequest($inventory_storage_activity_id)
    {
        ...
        $resourcePath = '/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteInventoryStorageActivityFileRequest($inventory_storage_activity_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateInventoryStorageActivityByIdRequest($inventory_storage_activity_id)
    {
        ...
        $resourcePath = '/v3.0/inventoryStorageActivity/duplicate/{inventoryStorageActivityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getInventoryStorageActivityByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/inventoryStorageActivity/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getInventoryStorageActivityTagsRequest($inventory_storage_activity_id)
    {
        ...
        $resourcePath = '/v3.0/inventoryStorageActivity/{inventoryStorageActivityId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
