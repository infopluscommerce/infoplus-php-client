...
class ItemSummaryCodeApi
{
    ...
    protected function addItemSummaryCodeRequest($body)
    {
        ...
        $resourcePath = '/v3.0/itemSummaryCode';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSummaryCodeAuditRequest($item_summary_code_id, $item_summary_code_audit)
    {
        ...
        $resourcePath = '/v3.0/itemSummaryCode/{itemSummaryCodeId}/audit/{itemSummaryCodeAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSummaryCodeFileRequest($item_summary_code_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/itemSummaryCode/{itemSummaryCodeId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSummaryCodeFileByURLRequest($body, $item_summary_code_id)
    {
        ...
        $resourcePath = '/v3.0/itemSummaryCode/{itemSummaryCodeId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addItemSummaryCodeTagRequest($item_summary_code_id, $item_summary_code_tag)
    {
        ...
        $resourcePath = '/v3.0/itemSummaryCode/{itemSummaryCodeId}/tag/{itemSummaryCodeTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemSummaryCodeRequest($item_summary_code_id)
    {
        ...
        $resourcePath = '/v3.0/itemSummaryCode/{itemSummaryCodeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteItemSummaryCodeFileRequest($item_summary_code_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/itemSummaryCode/{itemSummaryCodeId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateItemSummaryCodeByIdRequest($item_summary_code_id)
    {
        ...
        $resourcePath = '/v3.0/itemSummaryCode/duplicate/{itemSummaryCodeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemSummaryCodeByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/itemSummaryCode/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getItemSummaryCodeTagsRequest($item_summary_code_id)
    {
        ...
        $resourcePath = '/v3.0/itemSummaryCode/{itemSummaryCodeId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
