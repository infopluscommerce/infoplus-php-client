...
class ProductTypeApi
{
     ...
     * @return \Infoplus\Model\ProductType
     * @throws \Infoplus\ApiException on non-2xx response
     */
    public function getProductTypeById($product_type_id)
    {
        list($response, $statusCode, $httpHeader) = $this->getProductTypeByIdWithHttpInfo ($product_type_id);
        return $response; 
    }


    /**
     * getProductTypeByIdWithHttpInfo
     *
     * Get a productType by id
     *
     * @param string $product_type_id Id of productType to be returned. (required)
     * @return Array of \Infoplus\Model\ProductType, HTTP status code, HTTP response headers (array of strings)
     * @throws \Infoplus\ApiException on non-2xx response
     */
    public function getProductTypeByIdWithHttpInfo($product_type_id)
    {
        ...
        if ($product_type_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $product_type_id when calling getProductTypeById');
        }
  
        // parse inputs
        $resourcePath = "/v1.0/productType/{productTypeId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        if ($product_type_id !== null) {
            $resourcePath = str_replace(
                "{" . "productTypeId" . "}",
                $this->apiClient->getSerializer()->toPathValue($product_type_id),
                $resourcePath
            );
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams, '\Infoplus\Model\ProductType'
            );
            ...
            return array(\Infoplus\ObjectSerializer::deserialize($response, '\Infoplus\Model\ProductType', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \Infoplus\ObjectSerializer::deserialize($e->getResponseBody(), '\Infoplus\Model\ProductType', $e->getResponseHeaders());
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getProductTypeBySearchTextWithHttpInfo ($search_text, $page, $limit);
        return $response; 
    }


    /**
     * getProductTypeBySearchTextWithHttpInfo
     *
     * Search productTypes
     *
     * @param string $search_text Search text, used to filter results. (optional)
    ...
    public function getProductTypeBySearchTextWithHttpInfo($search_text = null, $page = null, $limit = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v1.0/productType/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
