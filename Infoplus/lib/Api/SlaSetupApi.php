...
class SlaSetupApi
{
     ...
     * @return void
     */
    public function addSlaSetupFile($sla_setup_id, $file_name)
    {
        $this->addSlaSetupFileWithHttpInfo($sla_setup_id, $file_name);
    }

    /**
     * Operation addSlaSetupFileWithHttpInfo
     *
     * Attach a file to a slaSetup
     *
     * @param  int $sla_setup_id Id of the slaSetup to add a file to (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function addSlaSetupFileWithHttpInfo($sla_setup_id, $file_name)
    {
        $returnType = '';
        $request = $this->addSlaSetupFileRequest($sla_setup_id, $file_name);
    ...
    /**
     * Operation addSlaSetupFileAsync
     *
     * Attach a file to a slaSetup
     *
     * @param  int $sla_setup_id Id of the slaSetup to add a file to (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addSlaSetupFileAsync($sla_setup_id, $file_name)
    {
        return $this->addSlaSetupFileAsyncWithHttpInfo($sla_setup_id, $file_name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addSlaSetupFileAsyncWithHttpInfo
     *
     * Attach a file to a slaSetup
     *
     * @param  int $sla_setup_id Id of the slaSetup to add a file to (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addSlaSetupFileAsyncWithHttpInfo($sla_setup_id, $file_name)
    {
        $returnType = '';
        $request = $this->addSlaSetupFileRequest($sla_setup_id, $file_name);
    ...
    /**
     * Create request for operation 'addSlaSetupFile'
     *
     * @param  int $sla_setup_id Id of the slaSetup to add a file to (required)
     * @param  string $file_name Name of file (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function addSlaSetupFileRequest($sla_setup_id, $file_name)
    {
        // verify the required parameter 'sla_setup_id' is set
        if ($sla_setup_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sla_setup_id when calling addSlaSetupFile'
            );
        }
        // verify the required parameter 'file_name' is set
        if ($file_name === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file_name when calling addSlaSetupFile'
            );
        }

        $resourcePath = '/beta/slaSetup/{slaSetupId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
