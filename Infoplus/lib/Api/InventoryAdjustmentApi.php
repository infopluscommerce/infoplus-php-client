...
class InventoryAdjustmentApi
{
    ...
    public function getDuplicateInventoryAdjustmentByIdWithHttpInfo($inventory_adjustment_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/inventoryAdjustment/duplicate/{inventoryAdjustmentId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getInventoryAdjustmentByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/inventoryAdjustment/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getInventoryAdjustmentByIdWithHttpInfo($inventory_adjustment_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/inventoryAdjustment/{inventoryAdjustmentId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateInventoryAdjustmentCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/inventoryAdjustment/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
