...
class InventoryAdjustmentApi
{
    ...
    protected function addInventoryAdjustmentAuditRequest($inventory_adjustment_id, $inventory_adjustment_audit)
    {
        ...
        $resourcePath = '/v3.0/inventoryAdjustment/{inventoryAdjustmentId}/audit/{inventoryAdjustmentAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInventoryAdjustmentFileRequest($inventory_adjustment_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/inventoryAdjustment/{inventoryAdjustmentId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInventoryAdjustmentFileByURLRequest($body, $inventory_adjustment_id)
    {
        ...
        $resourcePath = '/v3.0/inventoryAdjustment/{inventoryAdjustmentId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInventoryAdjustmentTagRequest($inventory_adjustment_id, $inventory_adjustment_tag)
    {
        ...
        $resourcePath = '/v3.0/inventoryAdjustment/{inventoryAdjustmentId}/tag/{inventoryAdjustmentTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteInventoryAdjustmentFileRequest($inventory_adjustment_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/inventoryAdjustment/{inventoryAdjustmentId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateInventoryAdjustmentByIdRequest($inventory_adjustment_id)
    {
        ...
        $resourcePath = '/v3.0/inventoryAdjustment/duplicate/{inventoryAdjustmentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getInventoryAdjustmentByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/inventoryAdjustment/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getInventoryAdjustmentByIdRequest($inventory_adjustment_id)
    {
        ...
        $resourcePath = '/v3.0/inventoryAdjustment/{inventoryAdjustmentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getInventoryAdjustmentTagsRequest($inventory_adjustment_id)
    {
        ...
        $resourcePath = '/v3.0/inventoryAdjustment/{inventoryAdjustmentId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateInventoryAdjustmentCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/inventoryAdjustment/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
