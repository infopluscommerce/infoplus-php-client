...
class CartonTypeApi
{
     ...
     * Create a cartonType
     *
     * @param \Infoplus\Model\CartonType $body CartonType to be inserted. (required)
     * @return \Infoplus\Model\CartonType
     * @throws \Infoplus\ApiException on non-2xx response
     */
    public function addCartonType($body)
    {
        list($response, $statusCode, $httpHeader) = $this->addCartonTypeWithHttpInfo ($body);
        return $response; 
    }


    /**
     * addCartonTypeWithHttpInfo
     *
     * Create a cartonType
     *
     * @param \Infoplus\Model\CartonType $body CartonType to be inserted. (required)
    ...
    public function addCartonTypeWithHttpInfo($body)
    {
        ...
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling addCartonType');
        }
  
        // parse inputs
        $resourcePath = "/v2.0/cartonType";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->deleteCartonTypeWithHttpInfo ($carton_type_id);
        return $response; 
    }


    /**
     * deleteCartonTypeWithHttpInfo
     *
     * Delete a cartonType
     *
     * @param int $carton_type_id Id of the cartonType to be deleted. (required)
    ...
    public function deleteCartonTypeWithHttpInfo($carton_type_id)
    {
        ...
        if ($carton_type_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $carton_type_id when calling deleteCartonType');
        }
  
        // parse inputs
        $resourcePath = "/v2.0/cartonType/{cartonTypeId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getCartonTypeByFilterWithHttpInfo ($filter, $page, $limit, $sort);
        return $response; 
    }


    /**
     * getCartonTypeByFilterWithHttpInfo
     *
     * Search cartonTypes by filter
     *
     * @param string $filter Query string, used to filter results. (optional)
    ...
    public function getCartonTypeByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/cartonType/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->getCartonTypeByIdWithHttpInfo ($carton_type_id);
        return $response; 
    }


    /**
     * getCartonTypeByIdWithHttpInfo
     *
     * Get a cartonType by id
     *
     * @param int $carton_type_id Id of the cartonType to be returned. (required)
    ...
    public function getCartonTypeByIdWithHttpInfo($carton_type_id)
    {
        ...
        // verify the required parameter 'carton_type_id' is set
        if ($carton_type_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $carton_type_id when calling getCartonTypeById');
        }
    ...
    public function getDuplicateCartonTypeByIdWithHttpInfo($carton_type_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/cartonType/duplicate/{cartonTypeId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * Update a cartonType
     *
     * @param \Infoplus\Model\CartonType $body CartonType to be updated. (required)
     * @return void
     * @throws \Infoplus\ApiException on non-2xx response
     */
    public function updateCartonType($body)
    {
        list($response, $statusCode, $httpHeader) = $this->updateCartonTypeWithHttpInfo ($body);
        return $response; 
    }


    /**
     * updateCartonTypeWithHttpInfo
     *
     * Update a cartonType
     *
     * @param \Infoplus\Model\CartonType $body CartonType to be updated. (required)
    ...
    public function updateCartonTypeWithHttpInfo($body)
    {
        ...
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling updateCartonType');
        }
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->updateCartonTypeCustomFieldsWithHttpInfo ($body);
        return $response; 
    }


    /**
     * updateCartonTypeCustomFieldsWithHttpInfo
     *
     * Update a cartonType custom fields
     *
     * @param \Infoplus\Model\CartonType $body CartonType to be updated. (required)
    ...
    public function updateCartonTypeCustomFieldsWithHttpInfo($body)
    {
        ...
        // verify the required parameter 'body' is set
        if ($body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $body when calling updateCartonTypeCustomFields');
        }
  
        // parse inputs
        $resourcePath = "/v2.0/cartonType/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
