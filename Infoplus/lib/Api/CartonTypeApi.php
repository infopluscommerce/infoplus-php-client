...
class CartonTypeApi
{
    ...
    protected function addCartonTypeAuditRequest($carton_type_id, $carton_type_audit)
    {
        ...
        $resourcePath = '/v3.0/cartonType/{cartonTypeId}/audit/{cartonTypeAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonTypeFileRequest($carton_type_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/cartonType/{cartonTypeId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonTypeFileByURLRequest($body, $carton_type_id)
    {
        ...
        $resourcePath = '/v3.0/cartonType/{cartonTypeId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonTypeTagRequest($carton_type_id, $carton_type_tag)
    {
        ...
        $resourcePath = '/v3.0/cartonType/{cartonTypeId}/tag/{cartonTypeTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteCartonTypeRequest($carton_type_id)
    {
        ...
        $resourcePath = '/v3.0/cartonType/{cartonTypeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteCartonTypeFileRequest($carton_type_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/cartonType/{cartonTypeId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCartonTypeByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/cartonType/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCartonTypeTagsRequest($carton_type_id)
    {
        ...
        $resourcePath = '/v3.0/cartonType/{cartonTypeId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateCartonTypeByIdRequest($carton_type_id)
    {
        ...
        $resourcePath = '/v3.0/cartonType/duplicate/{cartonTypeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateCartonTypeCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/cartonType/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
