...
class LoadContentApi
{
    ...
    protected function addLoadContentAuditRequest($load_content_id, $load_content_audit)
    {
        ...
        $resourcePath = '/v3.0/loadContent/{loadContentId}/audit/{loadContentAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLoadContentFileRequest($load_content_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/loadContent/{loadContentId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLoadContentFileByURLRequest($body, $load_content_id)
    {
        ...
        $resourcePath = '/v3.0/loadContent/{loadContentId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addLoadContentTagRequest($load_content_id, $load_content_tag)
    {
        ...
        $resourcePath = '/v3.0/loadContent/{loadContentId}/tag/{loadContentTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteLoadContentFileRequest($load_content_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/loadContent/{loadContentId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateLoadContentByIdRequest($load_content_id)
    {
        ...
        $resourcePath = '/v3.0/loadContent/duplicate/{loadContentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getLoadContentByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/loadContent/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getLoadContentByIdRequest($load_content_id)
    {
        ...
        $resourcePath = '/v3.0/loadContent/{loadContentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getLoadContentTagsRequest($load_content_id)
    {
        ...
        $resourcePath = '/v3.0/loadContent/{loadContentId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateLoadContentCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/loadContent/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
