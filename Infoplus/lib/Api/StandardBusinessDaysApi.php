...
class StandardBusinessDaysApi
{
    ...
    protected function addStandardBusinessDaysRequest($body)
    {
        ...
        $resourcePath = '/v3.0/standardBusinessDays';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addStandardBusinessDaysAuditRequest($standard_business_days_id, $standard_business_days_audit)
    {
        ...
        $resourcePath = '/v3.0/standardBusinessDays/{standardBusinessDaysId}/audit/{standardBusinessDaysAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addStandardBusinessDaysFileRequest($standard_business_days_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/standardBusinessDays/{standardBusinessDaysId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addStandardBusinessDaysFileByURLRequest($body, $standard_business_days_id)
    {
        ...
        $resourcePath = '/v3.0/standardBusinessDays/{standardBusinessDaysId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addStandardBusinessDaysTagRequest($standard_business_days_id, $standard_business_days_tag)
    {
        ...
        $resourcePath = '/v3.0/standardBusinessDays/{standardBusinessDaysId}/tag/{standardBusinessDaysTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteStandardBusinessDaysRequest($standard_business_days_id)
    {
        ...
        $resourcePath = '/v3.0/standardBusinessDays/{standardBusinessDaysId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteStandardBusinessDaysFileRequest($standard_business_days_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/standardBusinessDays/{standardBusinessDaysId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateStandardBusinessDaysByIdRequest($standard_business_days_id)
    {
        ...
        $resourcePath = '/v3.0/standardBusinessDays/duplicate/{standardBusinessDaysId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getStandardBusinessDaysByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/standardBusinessDays/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getStandardBusinessDaysTagsRequest($standard_business_days_id)
    {
        ...
        $resourcePath = '/v3.0/standardBusinessDays/{standardBusinessDaysId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
