...
class InvoiceWorksheetLineApi
{
    ...
    protected function addInvoiceWorksheetLineRequest($body)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheetLine';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInvoiceWorksheetLineAuditRequest($invoice_worksheet_line_id, $invoice_worksheet_line_audit)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/audit/{invoiceWorksheetLineAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInvoiceWorksheetLineFileRequest($invoice_worksheet_line_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInvoiceWorksheetLineFileByURLRequest($body, $invoice_worksheet_line_id)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addInvoiceWorksheetLineTagRequest($invoice_worksheet_line_id, $invoice_worksheet_line_tag)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/tag/{invoiceWorksheetLineTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteInvoiceWorksheetLineRequest($invoice_worksheet_line_id)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteInvoiceWorksheetLineFileRequest($invoice_worksheet_line_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateInvoiceWorksheetLineByIdRequest($invoice_worksheet_line_id)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheetLine/duplicate/{invoiceWorksheetLineId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getInvoiceWorksheetLineByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheetLine/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getInvoiceWorksheetLineTagsRequest($invoice_worksheet_line_id)
    {
        ...
        $resourcePath = '/v3.0/invoiceWorksheetLine/{invoiceWorksheetLineId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
