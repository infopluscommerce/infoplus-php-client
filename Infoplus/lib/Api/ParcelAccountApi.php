...
class ParcelAccountApi
{
    ...
    protected function addParcelAccountRequest($body)
    {
        ...
        $resourcePath = '/v3.0/parcelAccount';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addParcelAccountAuditRequest($parcel_account_id, $parcel_account_audit)
    {
        ...
        $resourcePath = '/v3.0/parcelAccount/{parcelAccountId}/audit/{parcelAccountAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addParcelAccountFileRequest($parcel_account_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/parcelAccount/{parcelAccountId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addParcelAccountFileByURLRequest($body, $parcel_account_id)
    {
        ...
        $resourcePath = '/v3.0/parcelAccount/{parcelAccountId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addParcelAccountTagRequest($parcel_account_id, $parcel_account_tag)
    {
        ...
        $resourcePath = '/v3.0/parcelAccount/{parcelAccountId}/tag/{parcelAccountTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteParcelAccountFileRequest($parcel_account_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/parcelAccount/{parcelAccountId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateParcelAccountByIdRequest($parcel_account_id)
    {
        ...
        $resourcePath = '/v3.0/parcelAccount/duplicate/{parcelAccountId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getParcelAccountByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/parcelAccount/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getParcelAccountByIdRequest($parcel_account_id)
    {
        ...
        $resourcePath = '/v3.0/parcelAccount/{parcelAccountId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getParcelAccountTagsRequest($parcel_account_id)
    {
        ...
        $resourcePath = '/v3.0/parcelAccount/{parcelAccountId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateParcelAccountCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/parcelAccount/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
