...
class LocationAddressSchemeApi
{
    ...
    public function addLocationAddressSchemeWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/locationAddressScheme";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function deleteLocationAddressSchemeWithHttpInfo($location_address_scheme_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/locationAddressScheme/{locationAddressSchemeId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getDuplicateLocationAddressSchemeByIdWithHttpInfo($location_address_scheme_id)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/locationAddressScheme/duplicate/{locationAddressSchemeId}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function getLocationAddressSchemeByFilterWithHttpInfo($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/locationAddressScheme/search";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    public function updateLocationAddressSchemeCustomFieldsWithHttpInfo($body)
    {
        ...
        // parse inputs
        $resourcePath = "/v2.0/locationAddressScheme/customFields";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
