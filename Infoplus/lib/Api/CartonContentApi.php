...
class CartonContentApi
{
    ...
    protected function addCartonContentRequest($body)
    {
        ...
        $resourcePath = '/v3.0/cartonContent';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonContentAuditRequest($carton_content_id, $carton_content_audit)
    {
        ...
        $resourcePath = '/v3.0/cartonContent/{cartonContentId}/audit/{cartonContentAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonContentFileRequest($carton_content_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/cartonContent/{cartonContentId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonContentFileByURLRequest($body, $carton_content_id)
    {
        ...
        $resourcePath = '/v3.0/cartonContent/{cartonContentId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addCartonContentTagRequest($carton_content_id, $carton_content_tag)
    {
        ...
        $resourcePath = '/v3.0/cartonContent/{cartonContentId}/tag/{cartonContentTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteCartonContentRequest($carton_content_id)
    {
        ...
        $resourcePath = '/v3.0/cartonContent/{cartonContentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteCartonContentFileRequest($carton_content_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/cartonContent/{cartonContentId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCartonContentByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/cartonContent/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getCartonContentTagsRequest($carton_content_id)
    {
        ...
        $resourcePath = '/v3.0/cartonContent/{cartonContentId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateCartonContentByIdRequest($carton_content_id)
    {
        ...
        $resourcePath = '/v3.0/cartonContent/duplicate/{cartonContentId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateCartonContentCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/cartonContent/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
