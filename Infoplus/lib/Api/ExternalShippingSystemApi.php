...
class ExternalShippingSystemApi
{
    ...
    protected function addExternalShippingSystemRequest($body)
    {
        ...
        $resourcePath = '/v3.0/externalShippingSystem';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addExternalShippingSystemAuditRequest($external_shipping_system_id, $external_shipping_system_audit)
    {
        ...
        $resourcePath = '/v3.0/externalShippingSystem/{externalShippingSystemId}/audit/{externalShippingSystemAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addExternalShippingSystemFileRequest($external_shipping_system_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/externalShippingSystem/{externalShippingSystemId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addExternalShippingSystemFileByURLRequest($body, $external_shipping_system_id)
    {
        ...
        $resourcePath = '/v3.0/externalShippingSystem/{externalShippingSystemId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addExternalShippingSystemTagRequest($external_shipping_system_id, $external_shipping_system_tag)
    {
        ...
        $resourcePath = '/v3.0/externalShippingSystem/{externalShippingSystemId}/tag/{externalShippingSystemTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteExternalShippingSystemRequest($external_shipping_system_id)
    {
        ...
        $resourcePath = '/v3.0/externalShippingSystem/{externalShippingSystemId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteExternalShippingSystemFileRequest($external_shipping_system_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/externalShippingSystem/{externalShippingSystemId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateExternalShippingSystemByIdRequest($external_shipping_system_id)
    {
        ...
        $resourcePath = '/v3.0/externalShippingSystem/duplicate/{externalShippingSystemId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getExternalShippingSystemByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/externalShippingSystem/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getExternalShippingSystemTagsRequest($external_shipping_system_id)
    {
        ...
        $resourcePath = '/v3.0/externalShippingSystem/{externalShippingSystemId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateExternalShippingSystemCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/externalShippingSystem/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
