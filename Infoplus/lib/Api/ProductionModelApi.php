...
class ProductionModelApi
{
    ...
    protected function addProductionModelRequest($body)
    {
        ...
        $resourcePath = '/v3.0/productionModel';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addProductionModelAuditRequest($production_model_id, $production_model_audit)
    {
        ...
        $resourcePath = '/v3.0/productionModel/{productionModelId}/audit/{productionModelAudit}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addProductionModelFileRequest($production_model_id, $file_name)
    {
        ...
        $resourcePath = '/v3.0/productionModel/{productionModelId}/file/{fileName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addProductionModelFileByURLRequest($body, $production_model_id)
    {
        ...
        $resourcePath = '/v3.0/productionModel/{productionModelId}/file';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function addProductionModelTagRequest($production_model_id, $production_model_tag)
    {
        ...
        $resourcePath = '/v3.0/productionModel/{productionModelId}/tag/{productionModelTag}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteProductionModelRequest($production_model_id)
    {
        ...
        $resourcePath = '/v3.0/productionModel/{productionModelId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function deleteProductionModelFileRequest($production_model_id, $file_id)
    {
        ...
        $resourcePath = '/v3.0/productionModel/{productionModelId}/file/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getDuplicateProductionModelByIdRequest($production_model_id)
    {
        ...
        $resourcePath = '/v3.0/productionModel/duplicate/{productionModelId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getProductionModelByFilterRequest($filter = null, $page = null, $limit = null, $sort = null)
    {
        ...
        $resourcePath = '/v3.0/productionModel/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function getProductionModelTagsRequest($production_model_id)
    {
        ...
        $resourcePath = '/v3.0/productionModel/{productionModelId}/tag';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function updateProductionModelCustomFieldsRequest($body)
    {
        ...
        $resourcePath = '/v3.0/productionModel/customFields';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
