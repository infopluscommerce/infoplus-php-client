...
------------- | ------------- | -------------
[**getAlertByFilter**](AlertApi.md#getAlertByFilter) | **GET** /v2.0/alert/search | Search alerts by filter
[**getAlertById**](AlertApi.md#getAlertById) | **GET** /v2.0/alert/{alertId} | Get an alert by id
[**getDuplicateAlertById**](AlertApi.md#getDuplicateAlertById) | **GET** /v2.0/alert/duplicate/{alertId} | Get a duplicated an alert by id
[**updateAlertCustomFields**](AlertApi.md#updateAlertCustomFields) | **PUT** /v2.0/alert/customFields | Update an alert custom fields
