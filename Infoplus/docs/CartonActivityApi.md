...
# **addCartonActivity**
> \Infoplus\Model\CartonActivity addCartonActivity($body)
...
$api_instance = new Infoplus\Api\CartonActivityApi();
$body = new \Infoplus\Model\CartonActivity(); // \Infoplus\Model\CartonActivity | CartonActivity to be inserted.

try { 
    $result = $api_instance->addCartonActivity($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CartonActivityApi->addCartonActivity: ', $e->getMessage(), "\n";
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Infoplus\Model\CartonActivity**](\Infoplus\Model\CartonActivity.md)| CartonActivity to be inserted. | 

### Return type

[**\Infoplus\Model\CartonActivity**](CartonActivity.md)
...
try { 
    $api_instance->addCartonActivityAudit($carton_activity_id, $carton_activity_audit);
} catch (Exception $e) {
    echo 'Exception when calling CartonActivityApi->addCartonActivityAudit: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    $api_instance->addCartonActivityTag($carton_activity_id, $carton_activity_tag);
} catch (Exception $e) {
    echo 'Exception when calling CartonActivityApi->addCartonActivityTag: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    $api_instance->deleteCartonActivity($carton_activity_id);
} catch (Exception $e) {
    echo 'Exception when calling CartonActivityApi->deleteCartonActivity: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    $api_instance->deleteCartonActivityTag($carton_activity_id, $carton_activity_tag);
} catch (Exception $e) {
    echo 'Exception when calling CartonActivityApi->deleteCartonActivityTag: ', $e->getMessage(), "\n";
}
?>
```
...
> \Infoplus\Model\CartonActivity[] getCartonActivityByFilter($filter, $page, $limit, $sort)
...
try { 
    $result = $api_instance->getCartonActivityByFilter($filter, $page, $limit, $sort);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CartonActivityApi->getCartonActivityByFilter: ', $e->getMessage(), "\n";
}
?>
```
...
> \Infoplus\Model\CartonActivity getCartonActivityById($carton_activity_id)
...
try { 
    $result = $api_instance->getCartonActivityById($carton_activity_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CartonActivityApi->getCartonActivityById: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    $api_instance->getCartonActivityTags($carton_activity_id);
} catch (Exception $e) {
    echo 'Exception when calling CartonActivityApi->getCartonActivityTags: ', $e->getMessage(), "\n";
}
?>
```
...
> \Infoplus\Model\CartonActivity getDuplicateCartonActivityById($carton_activity_id)
...
try { 
    $result = $api_instance->getDuplicateCartonActivityById($carton_activity_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CartonActivityApi->getDuplicateCartonActivityById: ', $e->getMessage(), "\n";
}
?>
```
...
$api_instance = new Infoplus\Api\CartonActivityApi();
$body = new \Infoplus\Model\CartonActivity(); // \Infoplus\Model\CartonActivity | CartonActivity to be updated.

try { 
    $api_instance->updateCartonActivity($body);
} catch (Exception $e) {
    echo 'Exception when calling CartonActivityApi->updateCartonActivity: ', $e->getMessage(), "\n";
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Infoplus\Model\CartonActivity**](\Infoplus\Model\CartonActivity.md)| CartonActivity to be updated. | 
