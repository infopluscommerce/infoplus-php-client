...
------------- | ------------- | -------------
[**addCustomer**](CustomerApi.md#addCustomer) | **POST** /v2.0/customer | Create a customer
[**deleteCustomer**](CustomerApi.md#deleteCustomer) | **DELETE** /v2.0/customer/{customerId} | Delete a customer
[**getByCustomerNo**](CustomerApi.md#getByCustomerNo) | **GET** /v2.0/customer/getByCustomerNo | Get a customer by Customer No
[**getCustomerByFilter**](CustomerApi.md#getCustomerByFilter) | **GET** /v2.0/customer/search | Search customers by filter
[**getCustomerById**](CustomerApi.md#getCustomerById) | **GET** /v2.0/customer/{customerId} | Get a customer by id
[**getDuplicateCustomerById**](CustomerApi.md#getDuplicateCustomerById) | **GET** /v2.0/customer/duplicate/{customerId} | Get a duplicated a customer by id
[**updateCustomer**](CustomerApi.md#updateCustomer) | **PUT** /v2.0/customer | Update a customer
[**updateCustomerCustomFields**](CustomerApi.md#updateCustomerCustomFields) | **PUT** /v2.0/customer/customFields | Update a customer custom fields
