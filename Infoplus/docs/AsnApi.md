...
------------- | ------------- | -------------
[**addAsn**](AsnApi.md#addAsn) | **POST** /v2.0/asn | Create an asn
[**deleteAsn**](AsnApi.md#deleteAsn) | **DELETE** /v2.0/asn/{asnId} | Delete an asn
[**getAsnByFilter**](AsnApi.md#getAsnByFilter) | **GET** /v2.0/asn/search | Search asns by filter
[**getAsnById**](AsnApi.md#getAsnById) | **GET** /v2.0/asn/{asnId} | Get an asn by id
[**getDuplicateAsnById**](AsnApi.md#getDuplicateAsnById) | **GET** /v2.0/asn/duplicate/{asnId} | Get a duplicated an asn by id
[**updateAsn**](AsnApi.md#updateAsn) | **PUT** /v2.0/asn | Update an asn
[**updateAsnCustomFields**](AsnApi.md#updateAsnCustomFields) | **PUT** /v2.0/asn/customFields | Update an asn custom fields
