...
> \Infoplus\Infoplus\Model\FinanceSystemConnectionLog addFinanceSystemConnectionLog($body)
...
$body = new \Infoplus\Infoplus\Model\FinanceSystemConnectionLog(); // \Infoplus\Infoplus\Model\FinanceSystemConnectionLog | FinanceSystemConnectionLog to be inserted.

try {
    $result = $apiInstance->addFinanceSystemConnectionLog($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FinanceSystemConnectionLogApi->addFinanceSystemConnectionLog: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Infoplus\Infoplus\Model\FinanceSystemConnectionLog**](../Model/FinanceSystemConnectionLog.md)| FinanceSystemConnectionLog to be inserted. |
...
> deleteFinanceSystemConnectionLog($finance_system_connection_log_id)
...
try {
    $apiInstance->deleteFinanceSystemConnectionLog($finance_system_connection_log_id);
} catch (Exception $e) {
    echo 'Exception when calling FinanceSystemConnectionLogApi->deleteFinanceSystemConnectionLog: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
$body = new \Infoplus\Infoplus\Model\FinanceSystemConnectionLog(); // \Infoplus\Infoplus\Model\FinanceSystemConnectionLog | FinanceSystemConnectionLog to be updated.

try {
    $apiInstance->updateFinanceSystemConnectionLog($body);
} catch (Exception $e) {
    echo 'Exception when calling FinanceSystemConnectionLogApi->updateFinanceSystemConnectionLog: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Infoplus\Infoplus\Model\FinanceSystemConnectionLog**](../Model/FinanceSystemConnectionLog.md)| FinanceSystemConnectionLog to be updated. |
