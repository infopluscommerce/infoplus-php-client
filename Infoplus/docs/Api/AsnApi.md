...
[**closeAsn**](AsnApi.md#closeAsn) | **POST** /beta/asn/closeAsn | Run the ClosePurchProcess process.
...
# **closeAsn**
> \Infoplus\Infoplus\Model\ProcessOutputAPIModel[] closeAsn($body)

Run the ClosePurchProcess process.
...
$body = new \Infoplus\Infoplus\Model\ClosePurchProcessInputAPIModel(); // \Infoplus\Infoplus\Model\ClosePurchProcessInputAPIModel | Input data for ClosePurchProcess process.

try {
    $result = $apiInstance->closeAsn($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AsnApi->closeAsn: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Infoplus\Infoplus\Model\ClosePurchProcessInputAPIModel**](../Model/ClosePurchProcessInputAPIModel.md)| Input data for ClosePurchProcess process. |
