...
# **addLocation**
> \Infoplus\Infoplus\Model\Location addLocation($body)
...
$apiInstance = new Infoplus\Api\LocationApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \Infoplus\Infoplus\Model\Location(); // \Infoplus\Infoplus\Model\Location | Location to be inserted.

try {
    $result = $apiInstance->addLocation($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LocationApi->addLocation: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Infoplus\Infoplus\Model\Location**](../Model/Location.md)| Location to be inserted. |

### Return type

[**\Infoplus\Infoplus\Model\Location**](../Model/Location.md)
...
try {
    $apiInstance->addLocationAudit($location_id, $location_audit);
} catch (Exception $e) {
    echo 'Exception when calling LocationApi->addLocationAudit: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **addLocationFile**
> addLocationFile($location_id, $file_name)
...
try {
    $apiInstance->addLocationFile($location_id, $file_name);
} catch (Exception $e) {
    echo 'Exception when calling LocationApi->addLocationFile: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> addLocationFileByURL($body, $location_id)
...
try {
    $apiInstance->addLocationFileByURL($body, $location_id);
} catch (Exception $e) {
    echo 'Exception when calling LocationApi->addLocationFileByURL: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $apiInstance->addLocationTag($location_id, $location_tag);
} catch (Exception $e) {
    echo 'Exception when calling LocationApi->addLocationTag: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **deleteLocationFile**
> deleteLocationFile($location_id, $file_id)
...
try {
    $apiInstance->deleteLocationFile($location_id, $file_id);
} catch (Exception $e) {
    echo 'Exception when calling LocationApi->deleteLocationFile: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $apiInstance->deleteLocationTag($location_id, $location_tag);
} catch (Exception $e) {
    echo 'Exception when calling LocationApi->deleteLocationTag: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Infoplus\Infoplus\Model\Location getDuplicateLocationById($location_id)
...
try {
    $result = $apiInstance->getDuplicateLocationById($location_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LocationApi->getDuplicateLocationById: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getLocationByFilter**
> \Infoplus\Infoplus\Model\Location[] getLocationByFilter($filter, $page, $limit, $sort)
...
try {
    $result = $apiInstance->getLocationByFilter($filter, $page, $limit, $sort);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling LocationApi->getLocationByFilter: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getLocationById**
> \Infoplus\Infoplus\Model\Location getLocationById($location_id)
...
try {
    ...
    echo 'Exception when calling LocationApi->getLocationById: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $apiInstance->getLocationFiles($location_id);
} catch (Exception $e) {
    echo 'Exception when calling LocationApi->getLocationFiles: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $apiInstance->getLocationTags($location_id);
} catch (Exception $e) {
...
$body = new \Infoplus\Infoplus\Model\Location(); // \Infoplus\Infoplus\Model\Location | Location to be updated.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Infoplus\Infoplus\Model\Location**](../Model/Location.md)| Location to be updated. |
...
try {
    ...
    echo 'Exception when calling LocationApi->updateLocationCustomFields: ', $e->getMessage(), PHP_EOL;
}
?>
```
