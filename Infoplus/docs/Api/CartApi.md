...
# **addCart**
> \Infoplus\Infoplus\Model\Cart addCart($body)
...
$apiInstance = new Infoplus\Api\CartApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \Infoplus\Infoplus\Model\Cart(); // \Infoplus\Infoplus\Model\Cart | Cart to be inserted.

try {
    $result = $apiInstance->addCart($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CartApi->addCart: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Infoplus\Infoplus\Model\Cart**](../Model/Cart.md)| Cart to be inserted. |

### Return type

[**\Infoplus\Infoplus\Model\Cart**](../Model/Cart.md)
...
# **addCartAudit**
> addCartAudit($cart_id, $cart_audit)
...
$cart_audit = "cart_audit_example"; // string | The audit to add

try {
    $apiInstance->addCartAudit($cart_id, $cart_audit);
} catch (Exception $e) {
    echo 'Exception when calling CartApi->addCartAudit: ', $e->getMessage(), PHP_EOL;
}
?>
```
 ...
 **cart_audit** | **string**| The audit to add |
...
try {
    $apiInstance->addCartFile($cart_id, $file_name);
} catch (Exception $e) {
    echo 'Exception when calling CartApi->addCartFile: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $apiInstance->addCartFileByURL($body, $cart_id);
} catch (Exception $e) {
    echo 'Exception when calling CartApi->addCartFileByURL: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
$cart_tag = "cart_tag_example"; // string | The tag to add

try {
    $apiInstance->addCartTag($cart_id, $cart_tag);
} catch (Exception $e) {
    echo 'Exception when calling CartApi->addCartTag: ', $e->getMessage(), PHP_EOL;
}
?>
```
 ...
 **cart_tag** | **string**| The tag to add |
...
try {
    $apiInstance->deleteCart($cart_id);
} catch (Exception $e) {
...
# **deleteCartFile**
> deleteCartFile($cart_id, $file_id)
...
try {
    $apiInstance->deleteCartFile($cart_id, $file_id);
} catch (Exception $e) {
    echo 'Exception when calling CartApi->deleteCartFile: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **deleteCartTag**
> deleteCartTag($cart_id, $cart_tag)
...
$cart_tag = "cart_tag_example"; // string | The tag to delete

try {
    $apiInstance->deleteCartTag($cart_id, $cart_tag);
} catch (Exception $e) {
    echo 'Exception when calling CartApi->deleteCartTag: ', $e->getMessage(), PHP_EOL;
}
?>
```
 ...
 **cart_tag** | **string**| The tag to delete |
...
# **getCartByFilter**
> \Infoplus\Infoplus\Model\Cart[] getCartByFilter($filter, $page, $limit, $sort)
...
try {
    $result = $apiInstance->getCartByFilter($filter, $page, $limit, $sort);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CartApi->getCartByFilter: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getCartById**
> \Infoplus\Infoplus\Model\Cart getCartById($cart_id)
...
try {
    $result = $apiInstance->getCartById($cart_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CartApi->getCartById: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $apiInstance->getCartFiles($cart_id);
} catch (Exception $e) {
    echo 'Exception when calling CartApi->getCartFiles: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $apiInstance->getCartTags($cart_id);
} catch (Exception $e) {
    echo 'Exception when calling CartApi->getCartTags: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Infoplus\Infoplus\Model\Cart getDuplicateCartById($cart_id)
...
try {
    $result = $apiInstance->getDuplicateCartById($cart_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CartApi->getDuplicateCartById: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
$body = new \Infoplus\Infoplus\Model\Cart(); // \Infoplus\Infoplus\Model\Cart | Cart to be updated.

try {
    $apiInstance->updateCart($body);
} catch (Exception $e) {
    echo 'Exception when calling CartApi->updateCart: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Infoplus\Infoplus\Model\Cart**](../Model/Cart.md)| Cart to be updated. |
