...
> \Infoplus\Infoplus\Model\ProcessOutputAPIModel[] executeExternalShipment($body)
...
$body = new \Infoplus\Infoplus\Model\ExecuteExternalShipmentInputAPIModel(); // \Infoplus\Infoplus\Model\ExecuteExternalShipmentInputAPIModel | Input data for ExecuteExternalShipment process.

try {
    $result = $apiInstance->executeExternalShipment($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ExternalShipmentApi->executeExternalShipment: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Infoplus\Infoplus\Model\ExecuteExternalShipmentInputAPIModel**](../Model/ExecuteExternalShipmentInputAPIModel.md)| Input data for ExecuteExternalShipment process. |
