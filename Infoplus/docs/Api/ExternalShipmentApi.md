...
$body = new \Infoplus\Infoplus\Model\ExecuteExternalShipmentInputAPIModel(); // \Infoplus\Infoplus\Model\ExecuteExternalShipmentInputAPIModel | ExternalShipment to be executed.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Infoplus\Infoplus\Model\ExecuteExternalShipmentInputAPIModel**](../Model/ExecuteExternalShipmentInputAPIModel.md)| ExternalShipment to be executed. |
