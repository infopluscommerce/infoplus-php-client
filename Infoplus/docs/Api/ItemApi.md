...
# **addItem**
> \Infoplus\Infoplus\Model\Item addItem($body)
...
$apiInstance = new Infoplus\Api\ItemApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \Infoplus\Infoplus\Model\Item(); // \Infoplus\Infoplus\Model\Item | Item to be inserted.

try {
    $result = $apiInstance->addItem($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ItemApi->addItem: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Infoplus\Infoplus\Model\Item**](../Model/Item.md)| Item to be inserted. |

### Return type

[**\Infoplus\Infoplus\Model\Item**](../Model/Item.md)
...
try {
    $apiInstance->addItemAudit($item_id, $item_audit);
} catch (Exception $e) {
    echo 'Exception when calling ItemApi->addItemAudit: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $apiInstance->addItemFile($item_id, $file_name);
} catch (Exception $e) {
    echo 'Exception when calling ItemApi->addItemFile: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $apiInstance->addItemFileByURL($body, $item_id);
} catch (Exception $e) {
    echo 'Exception when calling ItemApi->addItemFileByURL: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $apiInstance->addItemTag($item_id, $item_tag);
} catch (Exception $e) {
    echo 'Exception when calling ItemApi->addItemTag: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **deleteItemFile**
> deleteItemFile($item_id, $file_id)
...
try {
    $apiInstance->deleteItemFile($item_id, $file_id);
} catch (Exception $e) {
    echo 'Exception when calling ItemApi->deleteItemFile: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $apiInstance->deleteItemTag($item_id, $item_tag);
} catch (Exception $e) {
    echo 'Exception when calling ItemApi->deleteItemTag: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getBySKU**
> \Infoplus\Infoplus\Model\Item getBySKU($lob_id, $sku)
...
try {
    $result = $apiInstance->getBySKU($lob_id, $sku);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ItemApi->getBySKU: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Infoplus\Infoplus\Model\Item getDuplicateItemById($item_id)
...
try {
    $result = $apiInstance->getDuplicateItemById($item_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ItemApi->getDuplicateItemById: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getItemByFilter**
> \Infoplus\Infoplus\Model\Item[] getItemByFilter($filter, $page, $limit, $sort)
...
try {
    $result = $apiInstance->getItemByFilter($filter, $page, $limit, $sort);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ItemApi->getItemByFilter: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getItemById**
> \Infoplus\Infoplus\Model\Item getItemById($item_id)
...
try {
    $result = $apiInstance->getItemById($item_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $apiInstance->getItemFiles($item_id);
} catch (Exception $e) {
    echo 'Exception when calling ItemApi->getItemFiles: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $apiInstance->getItemTags($item_id);
} catch (Exception $e) {
    echo 'Exception when calling ItemApi->getItemTags: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
$body = new \Infoplus\Infoplus\Model\Item(); // \Infoplus\Infoplus\Model\Item | Item to be updated.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Infoplus\Infoplus\Model\Item**](../Model/Item.md)| Item to be updated. |
...
try {
    ...
    echo 'Exception when calling ItemApi->updateItemCustomFields: ', $e->getMessage(), PHP_EOL;
}
?>
```
