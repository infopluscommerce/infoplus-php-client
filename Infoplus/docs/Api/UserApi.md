...
------------- | ------------- | -------------
[**getUserById**](UserApi.md#getUserById) | **GET** /v3.0/user/{userId} | Get an user by id
[**getUserBySearchText**](UserApi.md#getUserBySearchText) | **GET** /v3.0/user/search | Search users
