...
try { 
    $api_instance->addParcelAccountAudit($parcel_account_id, $parcel_account_audit);
} catch (Exception $e) {
    echo 'Exception when calling ParcelAccountApi->addParcelAccountAudit: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    $api_instance->addParcelAccountTag($parcel_account_id, $parcel_account_tag);
} catch (Exception $e) {
    echo 'Exception when calling ParcelAccountApi->addParcelAccountTag: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    $api_instance->deleteParcelAccountTag($parcel_account_id, $parcel_account_tag);
} catch (Exception $e) {
    echo 'Exception when calling ParcelAccountApi->deleteParcelAccountTag: ', $e->getMessage(), "\n";
}
?>
```
...
> \Infoplus\Model\ParcelAccount getDuplicateParcelAccountById($parcel_account_id)
...
try { 
    $result = $api_instance->getDuplicateParcelAccountById($parcel_account_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ParcelAccountApi->getDuplicateParcelAccountById: ', $e->getMessage(), "\n";
}
?>
```
...
try { 
    $api_instance->getParcelAccountTags($parcel_account_id);
} catch (Exception $e) {
    echo 'Exception when calling ParcelAccountApi->getParcelAccountTags: ', $e->getMessage(), "\n";
}
?>
```
